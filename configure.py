...
if config.COMPILER_IS_GCC:
    APP_CXXFLAGS = "-fno-exceptions -fno-rtti -Werror -Wall -Wno-reorder -Wno-switch -Wno-invalid-offsetof -Wno-unitialized -Wno-strict-aliasing -fmessage-length=0 -finline-functions -finline-limit=65536 "
else:
