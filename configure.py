...
if config.COMPILER_IS_GCC:
    APP_CXXFLAGS = "-fno-exceptions -Werror -Wall -Wno-reorder -Wno-switch -Wno-invalid-offsetof -Wno-uninitialized -fmessage-length=0 -finline-functions -Wno-parentheses -finline-limit=65536 "
    if config.getDebug():
