...
public:
    ...
    {
        const avmplus::Multiname* const mn = this->traits()->pool->precomputedMultiname(1367);
        avmplus::Atom args[1] = { thisRef.reinterpretCast<avmplus::ScriptObject>()->atom() };
    ...
    {
        avmplus::AvmCore* const core = ((avmplus::AvmCore*)(this->core()));
        const avmplus::Multiname* const mn = this->traits()->pool->precomputedMultiname(1366);
