...
const uint32_t avmplus_System_getNanosecondTimer = 55;
...
const uint32_t avmplus_System_apiVersion_get = 67;
const uint32_t avmplus_System_disposeXML = 68;
const uint32_t avmplus_System_pauseForGCIfCollectionImminent = 69;
...
const uint32_t avmplus_Domain_currentDomain_get = 186;
const uint32_t avmplus_Domain_MIN_DOMAIN_MEMORY_LENGTH_get = 187;
const uint32_t avmplus_Domain_private_init = 188;
const uint32_t avmplus_Domain_loadBytes = 190;
const uint32_t avmplus_Domain_getClass = 191;
const uint32_t avmplus_Domain_domainMemory_get = 193;
const uint32_t avmplus_Domain_domainMemory_set = 194;
const uint32_t native_script_function_flash_sampler_getMasterString = 196;
const uint32_t native_script_function_flash_sampler_getSavedThis = 197;
const uint32_t native_script_function_flash_sampler_getLexicalScopes = 198;
const uint32_t native_script_function_flash_sampler_isGetterSetter = 199;
const uint32_t native_script_function_flash_sampler__getInvocationCount = 200;
const uint32_t native_script_function_flash_sampler_getSampleCount = 204;
const uint32_t native_script_function_flash_sampler__getSamples = 205;
const uint32_t native_script_function_flash_sampler_getMemberNames = 207;
const uint32_t native_script_function_flash_sampler_getSize = 208;
const uint32_t native_script_function_flash_sampler__setSamplerCallback = 209;
const uint32_t native_script_function_flash_sampler_sampleInternalAllocs = 212;
const uint32_t native_script_function_flash_sampler_pauseSampling = 213;
const uint32_t native_script_function_flash_sampler_stopSampling = 214;
const uint32_t native_script_function_flash_sampler_startSampling = 215;
const uint32_t native_script_function_flash_sampler_clearSamples = 216;
const uint32_t flash_sampler_NewObjectSample_object_get = 225;
const uint32_t flash_sampler_NewObjectSample_size_get = 226;
const uint32_t flash_trace_Trace_setLevel = 232;
const uint32_t flash_trace_Trace_getLevel = 233;
const uint32_t flash_trace_Trace_setListener = 234;
const uint32_t flash_trace_Trace_getListener = 235;
const uint32_t flash_utils_Dictionary_private_init = 240;
