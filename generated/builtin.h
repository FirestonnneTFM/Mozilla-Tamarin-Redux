...
const uint32_t JSON_private_parseCore = 672;
const uint32_t JSON_private_stringifySpecializedToString = 673;
const uint32_t XML_ignoreComments_get = 725;
const uint32_t XML_ignoreComments_set = 726;
const uint32_t XML_ignoreProcessingInstructions_get = 727;
const uint32_t XML_ignoreProcessingInstructions_set = 728;
const uint32_t XML_ignoreWhitespace_get = 729;
const uint32_t XML_ignoreWhitespace_set = 730;
const uint32_t XML_prettyPrinting_get = 731;
const uint32_t XML_prettyPrinting_set = 732;
const uint32_t XML_prettyIndent_get = 733;
const uint32_t XML_prettyIndent_set = 734;
const uint32_t XML_AS3_toString = 738;
const uint32_t XML_AS3_hasOwnProperty = 739;
const uint32_t XML_AS3_propertyIsEnumerable = 740;
const uint32_t XML_AS3_addNamespace = 741;
const uint32_t XML_AS3_appendChild = 742;
const uint32_t XML_AS3_attribute = 743;
const uint32_t XML_AS3_attributes = 744;
const uint32_t XML_AS3_child = 745;
const uint32_t XML_AS3_childIndex = 746;
const uint32_t XML_AS3_children = 747;
const uint32_t XML_AS3_comments = 748;
const uint32_t XML_AS3_contains = 749;
const uint32_t XML_AS3_copy = 750;
const uint32_t XML_AS3_descendants = 751;
const uint32_t XML_AS3_elements = 752;
const uint32_t XML_AS3_hasComplexContent = 753;
const uint32_t XML_AS3_hasSimpleContent = 754;
const uint32_t XML_AS3_inScopeNamespaces = 755;
const uint32_t XML_AS3_insertChildAfter = 756;
const uint32_t XML_AS3_insertChildBefore = 757;
const uint32_t XML_AS3_localName = 759;
const uint32_t XML_AS3_name = 760;
const uint32_t XML_private__namespace = 761;
const uint32_t XML_AS3_namespaceDeclarations = 763;
const uint32_t XML_AS3_nodeKind = 764;
const uint32_t XML_AS3_normalize = 765;
const uint32_t XML_AS3_parent = 766;
const uint32_t XML_AS3_processingInstructions = 767;
const uint32_t XML_AS3_prependChild = 768;
const uint32_t XML_AS3_removeNamespace = 769;
const uint32_t XML_AS3_replace = 770;
const uint32_t XML_AS3_setChildren = 771;
const uint32_t XML_AS3_setLocalName = 772;
const uint32_t XML_AS3_setName = 773;
const uint32_t XML_AS3_setNamespace = 774;
const uint32_t XML_AS3_text = 775;
const uint32_t XML_AS3_toXMLString = 776;
const uint32_t XML_AS3_notification = 777;
const uint32_t XML_AS3_setNotification = 778;
const uint32_t XMLList_AS3_toString = 822;
const uint32_t XMLList_AS3_hasOwnProperty = 824;
const uint32_t XMLList_AS3_propertyIsEnumerable = 825;
const uint32_t XMLList_AS3_attribute = 826;
const uint32_t XMLList_AS3_attributes = 827;
const uint32_t XMLList_AS3_child = 828;
const uint32_t XMLList_AS3_children = 829;
const uint32_t XMLList_AS3_comments = 830;
const uint32_t XMLList_AS3_contains = 831;
const uint32_t XMLList_AS3_copy = 832;
const uint32_t XMLList_AS3_descendants = 833;
const uint32_t XMLList_AS3_elements = 834;
const uint32_t XMLList_AS3_hasComplexContent = 835;
const uint32_t XMLList_AS3_hasSimpleContent = 836;
const uint32_t XMLList_AS3_length = 837;
const uint32_t XMLList_AS3_name = 838;
const uint32_t XMLList_AS3_normalize = 839;
const uint32_t XMLList_AS3_parent = 840;
const uint32_t XMLList_AS3_processingInstructions = 841;
const uint32_t XMLList_AS3_text = 842;
const uint32_t XMLList_AS3_toXMLString = 843;
const uint32_t XMLList_AS3_addNamespace = 844;
const uint32_t XMLList_AS3_appendChild = 845;
const uint32_t XMLList_AS3_childIndex = 846;
const uint32_t XMLList_AS3_inScopeNamespaces = 847;
const uint32_t XMLList_AS3_insertChildAfter = 848;
const uint32_t XMLList_AS3_insertChildBefore = 849;
const uint32_t XMLList_AS3_nodeKind = 850;
const uint32_t XMLList_private__namespace = 851;
const uint32_t XMLList_AS3_localName = 853;
const uint32_t XMLList_AS3_namespaceDeclarations = 854;
const uint32_t XMLList_AS3_prependChild = 855;
const uint32_t XMLList_AS3_removeNamespace = 856;
const uint32_t XMLList_AS3_replace = 857;
const uint32_t XMLList_AS3_setChildren = 858;
const uint32_t XMLList_AS3_setLocalName = 859;
const uint32_t XMLList_AS3_setName = 860;
const uint32_t XMLList_AS3_setNamespace = 861;
const uint32_t QName_localName_get = 866;
const uint32_t QName_uri_get = 867;
const uint32_t flash_utils_Proxy_flash_proxy_isAttribute = 923;
const uint32_t flash_utils_Dictionary_private_init = 928;
const uint32_t flash_utils_ByteArray_defaultObjectEncoding_get = 935;
const uint32_t flash_utils_ByteArray_defaultObjectEncoding_set = 936;
const uint32_t flash_utils_ByteArray_readBytes = 938;
const uint32_t flash_utils_ByteArray_writeBytes = 939;
const uint32_t flash_utils_ByteArray_writeBoolean = 940;
const uint32_t flash_utils_ByteArray_writeByte = 941;
const uint32_t flash_utils_ByteArray_writeShort = 942;
const uint32_t flash_utils_ByteArray_writeInt = 943;
const uint32_t flash_utils_ByteArray_writeUnsignedInt = 944;
const uint32_t flash_utils_ByteArray_writeFloat = 945;
const uint32_t flash_utils_ByteArray_writeDouble = 946;
const uint32_t flash_utils_ByteArray_writeMultiByte = 947;
const uint32_t flash_utils_ByteArray_writeUTF = 948;
const uint32_t flash_utils_ByteArray_writeUTFBytes = 949;
const uint32_t flash_utils_ByteArray_readBoolean = 950;
const uint32_t flash_utils_ByteArray_readByte = 951;
const uint32_t flash_utils_ByteArray_readUnsignedByte = 952;
const uint32_t flash_utils_ByteArray_readShort = 953;
const uint32_t flash_utils_ByteArray_readUnsignedShort = 954;
const uint32_t flash_utils_ByteArray_readInt = 955;
const uint32_t flash_utils_ByteArray_readUnsignedInt = 956;
const uint32_t flash_utils_ByteArray_readFloat = 957;
const uint32_t flash_utils_ByteArray_readDouble = 958;
const uint32_t flash_utils_ByteArray_readMultiByte = 959;
const uint32_t flash_utils_ByteArray_readUTF = 960;
const uint32_t flash_utils_ByteArray_readUTFBytes = 961;
const uint32_t flash_utils_ByteArray_length_get = 962;
const uint32_t flash_utils_ByteArray_length_set = 963;
const uint32_t flash_utils_ByteArray_writeObject = 964;
const uint32_t flash_utils_ByteArray_readObject = 965;
const uint32_t flash_utils_ByteArray_private__compress = 967;
const uint32_t flash_utils_ByteArray_private__uncompress = 970;
const uint32_t flash_utils_ByteArray_private__toString = 973;
const uint32_t flash_utils_ByteArray_bytesAvailable_get = 974;
const uint32_t flash_utils_ByteArray_position_get = 975;
const uint32_t flash_utils_ByteArray_position_set = 976;
const uint32_t flash_utils_ByteArray_objectEncoding_get = 977;
const uint32_t flash_utils_ByteArray_objectEncoding_set = 978;
const uint32_t flash_utils_ByteArray_endian_get = 979;
const uint32_t flash_utils_ByteArray_endian_set = 980;
const uint32_t flash_utils_ByteArray_clear = 981;
