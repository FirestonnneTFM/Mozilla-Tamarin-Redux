...
AddTestCase("float4.distance() returns a float", "float", getQualifiedClassName(float4.distance(flt4, flt4)));
AddTestCase("float4.distance() length is 2", 2, float4.distance.length);
