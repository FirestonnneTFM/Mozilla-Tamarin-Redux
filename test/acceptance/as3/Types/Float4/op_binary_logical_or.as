...
AddTestCase("check(float4(1f, 2f, 3f, float.NaN), float4(-1f, -2f, -3f, -4f))", float4(1f, 2f, 3f, float.NaN), check(float4(1f, 2f, 3f, float.NaN), float4(-1f, -2f, -3f, -4f)));
AddTestCase("check(float4(1f, 2f, 3f, 4f), float4(0f, -2f, -3f, -4f))",  float4(1f, 2f, 3f, 4f), check(float4(1f, 2f, 3f, 4f) , float4(0f, -2f, -3f, -4f)));
AddTestCase("check(float4(1f, 2f, -0f, 4f), float4(-1f, -2f, -3f, -4f))", float4(1f, 2f, -0f, 4f), check(float4(1f, 2f, -0f, 4f), float4(-1f, -2f, -3f, -4f)));
