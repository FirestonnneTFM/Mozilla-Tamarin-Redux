...
AddTestCase("No range error for NaN", "NaN,NaN,NaN,NaN", test_flt4..AS3::toString(99));
test_flt4 = new float4(float.POSITIVE_INFINITY);
AddTestCase("No range error for +Inf", "Infinity,Infinity,Infinity,Infinity", test_flt4..AS3::toString(99));
...
AddTestCase("float4.AS3::toString: decimal", "5tqs,5tqs,5tqs,5tqs", test_flt4.AS3::toString(36.2)); // should covert radix to int
AddTestCase("float4.AS3::toString: hexadecimal", "5tqs,5tqs,5tqs,5tqs", test_flt4.AS3::toString(0x24)); // should covert radix to int

AddTestCase("float4.AS3::toString: NaN, in base 16", "NaN,NaN,NaN,NaN", float4(float.NaN).AS3::toString(16)); // base doesn't matter, still prints 'NaN'

AddTestCase("float4.AS3::toString: float.MAX_VALUE, in base 16",
...
AddTestCase("float4.AS3::toString: -float.MIN_VALUE, in base 16",
            "0,0,0,0",
