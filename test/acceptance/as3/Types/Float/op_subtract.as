...
AddTestCase("float subtraction result", float(1.2345024e+09), f1-f2);
AddTestCase("FloatLiteral subtraction result", float(1.2345024e+09), 1.2345678e9f-65432.10987f);
AddTestCase("subtraction on float & number should yield different results", true, (Number(f1)-Number(f2)) != Number(f1-f2) );
AddTestCase("subtraction of 2 floats returns a float", "float", getQualifiedClassName(f1-f2));
