...
AddTestCase("float.prototype.toLocaleString returns a String", "String", getQualifiedClassName(test_flt.toLocaleString()));

var orig_tostr = Object.prototype.toString;
Object.prototype.toLocaleString = float.prototype.toLocaleString;
var test_obj:Object = {};
AddErrorTest("float.prototype.toLocaleString() on Object throws TypeError ", TYPEERROR, function(){ test_obj.toLocaleString();});
// we test that it throws TypeError, not RangeError
AddErrorTest("float.prototype.toLocaleString(357) on Object throws TypeError", TYPEERROR, function(){ test_obj.toLocaleString(357);});
...
AddErrorTest("float.prototype.toLocaleString() non-generic= throws TypeError", TYPEERROR, function(){ test_num.toLocaleString();});
AddErrorTest("float.prototype.toLocaleString(357) non-generic= throws TypeError", TYPEERROR, function(){ test_num.toLocaleString(357);});
Number.prototype.toLocaleString = orig_tostr;

AddTestCase("float.prototype.toLocaleString = invokes AS3::toString", test_flt.AS3::toString(), test_flt.toLocaleString());
AddTestCase("float.prototype.toLocaleString(25) = invokes AS3::toString(25)", test_flt.AS3::toString(25), test_flt.toLocaleString(25));
...
AddTestCase("float.prototype.toLocaleString: implicit radix is 10", test_flt.toLocaleString(10), test_flt.toLocaleString());
