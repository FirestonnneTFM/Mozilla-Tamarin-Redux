...
function getTestCases() {
    ...
    array[item++] = new TestCase( SECTION,  "new Number('Infinity2')", Number.NaN, new Number("Infinity2") );
    // MathUtils::convertStringToDouble(), have more than 15 digits and an exponent
    array[item++] = new TestCase( SECTION,  "new Number('41254121515122343e2')", 4125412151512234500, new Number("41254121515122343e2") );
    // MathUtils::convertStringToDouble(), number with 308 decimal places
    array[item++] = new TestCase( SECTION,  "Number with 308 decimal places", 1.1234123413412336, new Number("1.") );

    // MathUtils::convertDoubleToString(), kFixedFraction write out significand
    array[item++] = new TestCase( SECTION,  "kFixedFraction write out significand", "0.000000120000000", new Number(0.12e-6).toFixed(15) );

    //MathUtils::convertDoubleToStringRadix
    array[item++] = new TestCase( SECTION,  "new Number(12.0).toString(2)",  "1100", new Number(12.0).toString(2) );
    array[item++] = new TestCase( SECTION,  "new Number(-1.0).toString(2)",  "-1", new Number(-1.0).toString(2) );
    array[item++] = new TestCase( SECTION,  "new Number(0.5).toString(2)",  "0", new Number(0.5).toString(2) );
