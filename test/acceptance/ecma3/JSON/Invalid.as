...
AddTestCase("Invalid JSON numerical input '-'","SyntaxError: Error #1132",exception1);
...
AddTestCase("Invalid JSON numerical input '.'","SyntaxError: Error #1132",exception2);
...
AddTestCase("valid JSON numerical input '1e'","SyntaxError: Error #1132",exception3);
...
AddTestCase("Invalid JSON numerical input '1E'","SyntaxError: Error #1132",exception4);
...
AddTestCase("Invalid JSON numerical input '1.e'","SyntaxError: Error #1132",exception5);
...
AddTestCase("Invalid JSON numerical input '\\'","SyntaxError: Error #1132",exception6);
...
AddTestCase("Invalid JSON unicode '\\u'","SyntaxError: Error #1132",exception7);
...
AddTestCase("Invalid JSON unicode '\\uG000'","SyntaxError: Error #1132",exception8);
...
AddTestCase("Invalid JSON unicode '\\u0G00'","SyntaxError: Error #1132",exception9);
...
AddTestCase("Invalid JSON unicode '\\u00G0'","SyntaxError: Error #1132",exception10);
...
AddTestCase("Invalid JSON unicode '\\u000G '","SyntaxError: Error #1132",exception11);
/*
...
AddTestCase("Invalid JSON unicode '\\u00bg'","SyntaxError: Error #1132",exception13);
...
AddTestCase("Invalid escape character \\z","SyntaxError: Error #1132",exception14);

AddTestCase("JSON valid input: Escaped Quotes","\"",JSON.parse("\"\\\"\""));
AddTestCase("JSON lowercase hex digits","JOKN",JSON.parse('"\u004a\u004f\u004b\u004e"'));
AddTestCase("JSON lowercase hex digits","JOKN",JSON.parse('"\u004A\u004F\u004B\u004E"'));

var v1=undefined;
AddTestCase("JSON stringify undefined","null",JSON.stringify(v1));
...
AddTestCase("JSON parse close to null 'nzll'","SyntaxError: Error #1132",exception15);
...
AddTestCase("JSON parse close to null 'nuzl'","SyntaxError: Error #1132",exception16);
...
AddTestCase("JSON parse close to null 'nulz'","SyntaxError: Error #1132",exception17);
...
AddTestCase("JSON parse close to null 'tzue'","SyntaxError: Error #1132",exception18);
...
AddTestCase("JSON parse close to null 'trze'","SyntaxError: Error #1132",exception19);
...
AddTestCase("JSON parse close to null 'truz'","SyntaxError: Error #1132",exception20);
...
AddTestCase("JSON parse close to null 'fzlse'","SyntaxError: Error #1132",exception21);
...
AddTestCase("JSON parse close to null 'fazse'","SyntaxError: Error #1132",exception22);
...
AddTestCase("JSON parse close to null 'falze'","SyntaxError: Error #1132",exception23);
...
AddTestCase("JSON parse close to null 'falsz'","SyntaxError: Error #1132",exception24);
...
AddTestCase("JSON parse invalid Array","SyntaxError: Error #1132",exception25);
...
AddTestCase("JSON parse invalid Array","SyntaxError: Error #1132",exception26);
*/
...
AddTestCase("JSON parse invalid Array","SyntaxError: Error #1132",exception27);
...
AddTestCase("JSON parse invalid Array","SyntaxError: Error #1132",exception28);
...
AddTestCase("JSON parse invalid Array","SyntaxError: Error #1132",exception29);
...
AddTestCase("JSON parse incomplete false","SyntaxError: Error #1132",exception30);
...
AddTestCase("JSON parse incomplete true","SyntaxError: Error #1132",exception31);
...
AddTestCase("JSON parse incomplete true","SyntaxError: Error #1132",exception32);
...
AddTestCase("JSON parse null","SyntaxError: Error #1132",exception33);
...
AddTestCase("JSON parse undefined","SyntaxError: Error #1132",exception34);
...
AddTestCase("JSON parse undefined","SyntaxError: Error #1132",exception35);
...
AddTestCase("JSON parse undefined","SyntaxError: Error #1132",exception36);
...
AddTestCase("JSON parse, reviver is not a function","TypeError: Error #1034",exception37);
...
AddTestCase("JSON parse, reviver throws error",reviverError,"Error: Reviver Error");
...
AddTestCase("JSON parse, reviver throws error",cyclicError,"TypeError: Error #1129");
