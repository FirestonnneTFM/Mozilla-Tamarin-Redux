...
echo "message: $py ./runtests.py --config=x86-win-tvm-cov-release --threads=$test_threads --nohtml"
$py ./runtests.py --config=x86-win-tvm-cov-release --threads=$test_threads --nohtml
