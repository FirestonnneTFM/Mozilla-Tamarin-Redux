...
echo "message: $py ./runtests.py --nohtml --vmargs=-Ojit --config=winmobile-emulator-tvm-release-Ojit-deep --notimecheck"
$py ./runtests.py --nohtml --vmargs=-Ojit --config=winmobile-emulator-tvm-release-Ojit-deep --notimecheck
