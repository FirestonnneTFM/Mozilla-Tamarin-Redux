...
echo "message: $py ./runtests.py --nohtml --vmargs=-Dinterp --config=winmobile-emulator-tvm-release-Dinterp-deep --notimecheck"
$py ./runtests.py --nohtml --vmargs=-Dinterp --config=winmobile-emulator-tvm-release-Dinterp-deep --notimecheck
