...
export basedir=c:/buildbot/tamarin-redux/$platform-arm/$branch
export buildsdir=c:/buildbot/tamarin-redux/$platform-arm/builds
export uploadbuildsdir=/c/buildbot/tamarin-redux/$platform-arm/builds
