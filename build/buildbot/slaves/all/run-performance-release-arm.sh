...
# standard performance run
    echo ""
    echo "===========   JSBench   ==========="
    python ./runtests.py --config=jsbench --vmversion=${change} -r $branch -k -f -i 3 --vmargs="\"$jsbench_memlimit\""
    test "$?" = "0" || { 
        result="1"; 
    ...
    echo ""
    echo "===========   Misc   ==========="
    python ./runtests.py --config=misc-mobile --vmversion=${change} -r $branch -k -f -i 3 --vmargs="\"$misc_memlimit\""
    test "$?" = "0" || { 
        result="1"; 
    ...
    echo ""
    echo "===========   SunSpider   ==========="
    python ./runtests.py --config=sunspider-mobile --vmversion=${change} -r $branch -k -f -i 10 --vmargs="\"$sunspider_memlimit\""
    test "$?" = "0" || { 
        result="1"; 
    ...
    echo ""
    echo "===========   V8   ==========="
    python ./runtests.py --config=v8 --vmversion=${change} -r $branch -k -f -i 3 --larger --vmargs="\"$v8_memlimit\""
    test "$?" = "0" || { 
        result="1"; 
