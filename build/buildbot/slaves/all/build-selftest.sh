...
##
cd $basedir
test -d objdir-selftests && {
    echo Remove directory $basedir/objdir-selftests
    rm -rf $basedir/objdir-selftests
}

mkdir objdir-selftests

cd objdir-selftests

python ../configure.py --enable-shell --enable-selftest $2
...
cp shell/$shell_release $buildsdir/${change}-${changeid}/$platform/$shell_selftests
chmod 777 $buildsdir/${change}-${changeid}/$platform/$shell_selftests
