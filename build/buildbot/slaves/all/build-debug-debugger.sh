...
##
cd $basedir
test -d objdir-debugdebugger && {
    echo Remove directory $basedir/objdir-debugdebugger
    rm -rf $basedir/objdir-debugdebugger
}

mkdir objdir-debugdebugger

cd objdir-debugdebugger

python ../configure.py --enable-shell --enable-debug --enable-debugger $2
...
cp shell/$shell_release $buildsdir/${change}-${changeid}/$platform/$shell_debug_debugger
chmod 777 $buildsdir/${change}-${changeid}/$platform/$shell_debug_debugger
