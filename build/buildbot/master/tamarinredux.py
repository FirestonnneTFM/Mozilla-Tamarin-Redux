...
class tamarinredux:
    ...
    windows_compile_factory.addStep(verify_builtinabc)    
    ...
    windows_compile_factory.addStep(verify_tracers)    
    ...
    windows_64_compile_factory.addStep(verify_builtinabc)    
    ...
    windows_64_compile_factory.addStep(verify_tracers)
    ...
    mac_intel_105_compile_factory.addStep(verify_builtinabc)    
    ...
    mac_intel_105_compile_factory.addStep(verify_tracers)
    ...
    mac_intel_64_compile_factory.addStep(verify_builtinabc)    
    ...
    linux_compile_factory.addStep(verify_builtinabc)    
    ...
    linux_compile_factory.addStep(verify_tracers)
    ...
    linux_64_compile_factory.addStep(verify_builtinabc)    
    ...
    android_compile_factory.addStep(verify_builtinabc)    
    ...
    android_compile_factory.addStep(verify_tracers)
    ...
    linux_arm_compile_factory.addStep(verify_builtinabc)    
    ...
    linux_arm_compile_factory.addStep(verify_tracers)
    ...
    windows_deep_factory.addStep(compile_generic(name="Release-aot", shellname="avmshell_aot", args="--enable-aot", upload="false", features="+AVMSYSTEM_32BIT +AVMSYSTEM_IA32 +AVMFEATURE_AOT"))
    windows_deep_factory.addStep(compile_generic(name="Debug-aot", shellname="avmshell_d_aot", args="--enable-debug --enable-aot", upload="false", features="+AVMSYSTEM_32BIT +AVMSYSTEM_IA32 +AVMFEATURE_AOT"))    
    windows_deep_factory.addStep(test_generic(name="Release-aot", shellname="avmshell_aot", vmargs="", config="AOT", scriptargs=""))
    windows_deep_factory.addStep(test_generic(name="Debug-aot", shellname="avmshell_d_aot", vmargs="", config="AOT", scriptargs=""))    
    ...
    windows_64_deep_factory.addStep(compile_generic(name="Release-aot", shellname="avmshell_aot_64", args="--enable-aot --target=x86_64-win", upload="false", features="+AVMSYSTEM_64BIT +AVMSYSTEM_AMD64 +AVMFEATURE_AOT"))
    windows_64_deep_factory.addStep(compile_generic(name="Debug-aot", shellname="avmshell_d_aot_64", args="--enable-debug --enable-aot --target=x86_64-win", upload="false", features="+AVMSYSTEM_64BIT +AVMSYSTEM_AMD64 +AVMFEATURE_AOT"))
    windows_64_deep_factory.addStep(test_generic(name="Release-aot", shellname="avmshell_aot_64", vmargs="", config="AOT", scriptargs=""))
    windows_64_deep_factory.addStep(test_generic(name="Debug-aot", shellname="avmshell_d_aot_64", vmargs="", config="AOT", scriptargs=""))    
    ...
    mac_deep_factory.addStep(compile_generic(name="Debug-aot", shellname="avmshell_d_aot", args="--enable-debug --enable-aot --target=i686-darwin --mac-sdk=105", upload="false", features="+AVMSYSTEM_32BIT +AVMSYSTEM_IA32 +AVMFEATURE_AOT"))
    mac_deep_factory.addStep(test_generic(name="Release-aot", shellname="avmshell_aot", vmargs="", config="AOT", scriptargs=""))
    mac_deep_factory.addStep(test_generic(name="Debug-aot", shellname="avmshell_d_aot", vmargs="", config="AOT", scriptargs=""))    
    ...
    mac64_deep_factory.addStep(compile_generic(name="Release-aot", shellname="avmshell_aot_64", args="--enable-aot --target=x86_64-darwin --mac-sdk=105", upload="false", features="+AVMSYSTEM_64BIT +AVMSYSTEM_AMD64 +AVMFEATURE_AOT"))
    mac64_deep_factory.addStep(compile_generic(name="Debug-aot", shellname="avmshell_d_aot_64", args="--enable-debug --enable-aot --target=x86_64-darwin --mac-sdk=105", upload="false", features="+AVMSYSTEM_64BIT +AVMSYSTEM_AMD64 +AVMFEATURE_AOT"))
    mac64_deep_factory.addStep(test_generic(name="Release-aot", shellname="avmshell_aot_64", vmargs="", config="AOT", scriptargs=""))
    mac64_deep_factory.addStep(test_generic(name="Debug-aot", shellname="avmshell_d_aot_64", vmargs="", config="AOT", scriptargs=""))    
    ...
    linux_deep_factory.addStep(compile_generic(name="Release-aot", shellname="avmshell_aot", args="--enable-aot", upload="false", features="+AVMSYSTEM_64BIT +AVMSYSTEM_AMD64 +AVMFEATURE_AOT"))
    linux_deep_factory.addStep(compile_generic(name="Debug-aot", shellname="avmshell_d_aot", args="--enable-debug --enable-aot", upload="false", features="+AVMSYSTEM_64BIT +AVMSYSTEM_AMD64 +AVMFEATURE_AOT"))
    linux_deep_factory.addStep(test_generic(name="Release-aot", shellname="avmshell_aot", vmargs="", config="AOT", scriptargs=""))
    linux_deep_factory.addStep(test_generic(name="Debug-aot", shellname="avmshell_d_aot", vmargs="", config="AOT", scriptargs=""))    
    ...
    linux_arm_deep_factory.addStep(compile_generic(name="Release-aot", shellname="avmshell_neon_arm_aot", args="--enable-arm-neon --arm-arch=armv7-a --target=arm-linux --enable-sys-root-dir=/usr/local/arm-linux/debian5 --enable-aot", upload="false", features=""))
    linux_arm_deep_factory.addStep(compile_generic(name="Debug-aot", shellname="avmshell_neon_arm_d_aot", args="--enable-debug --enable-arm-neon --arm-arch=armv7-a --target=arm-linux --enable-sys-root-dir=/usr/local/arm-linux/debian5 --enable-aot", upload="false", features=""))
    linux_arm_deep_factory.addStep(test_generic_ssh(name="Release-aot", shellname="avmshell_neon_arm_aot", vmargs="", config="arm-lnx-tvm-release-aot", scriptargs=""))
    linux_arm_deep_factory.addStep(test_generic_ssh(name="Debug-aot", shellname="avmshell_neon_arm_d_aot", vmargs="", config="arm-lnx-tvm-debug-aot", scriptargs=""))    
    ...
    linux_mips_deep_factory.addStep(compile_generic(name="Release-aot", shellname="avmshell_mips_aot", args="--target=mips-linux --enable-aot", upload="false", features=""))
    linux_mips_deep_factory.addStep(compile_generic(name="Debug-aot", shellname="avmshell_mips_d_aot", args="--enable-debug --target=mips-linux --enable-aot", upload="false", features=""))
    linux_mips_deep_factory.addStep(test_generic_ssh(name="Release-aot", shellname="avmshell_mips_aot", vmargs="", config="mips-lnx-tvm-release-aot", scriptargs=""))
    linux_mips_deep_factory.addStep(test_generic_ssh(name="Debug-aot", shellname="avmshell_mips_d_aot", vmargs="", config="mips-lnx-tvm-debug-aot", scriptargs=""))    
