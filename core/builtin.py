...
os.system(asc+" -builtin "+configs+" -apiversioning -out builtin builtin.as Date.as RegExp.as JSON.as XML.as IDataInput.as IDataOutput.as ByteArray.as Proxy.as ")
