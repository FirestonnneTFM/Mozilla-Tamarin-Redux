    ...
    namespace ErrorConstants
    {
        ...
        const char* errorConstants[][kNumErrorConstants] =
        {
            ...
            // en
            {
                ...
                /*2004,142*/ "One of the parameters is invalid.",
                /*2006,143*/ "The supplied index is out of bounds.",
                /*2007,144*/ "Parameter %1 must be non-null.",
                /*2008,145*/ "Parameter %1 must be one of the accepted values.",
                /*2012,146*/ "%1 class cannot be instantiated.",
                /*2030,147*/ "End of file was encountered.",
                /*2058,148*/ "There was an error decompressing the data.",
                /*2085,149*/ "Parameter %1 must be non-empty string.",
                /*2088,150*/ "The Proxy class does not implement getProperty. It must be overridden by a subclass.",
                /*2089,151*/ "The Proxy class does not implement setProperty. It must be overridden by a subclass.",
                /*2090,152*/ "The Proxy class does not implement callProperty. It must be overridden by a subclass.",
                /*2091,153*/ "The Proxy class does not implement hasProperty. It must be overridden by a subclass.",
                /*2092,154*/ "The Proxy class does not implement deleteProperty. It must be overridden by a subclass.",
                /*2093,155*/ "The Proxy class does not implement getDescendants. It must be overridden by a subclass.",
                /*2105,156*/ "The Proxy class does not implement nextNameIndex. It must be overridden by a subclass.",
                /*2106,157*/ "The Proxy class does not implement nextName. It must be overridden by a subclass.",
                /*2107,158*/ "The Proxy class does not implement nextValue. It must be overridden by a subclass.",
                /*2108,159*/ "The value %1 is not a valid Array length.",
                /*2173,160*/ "Unable to read object in stream.  The class %1 does not implement flash.utils.IExternalizable but is aliased to an externalizable class."
            },
        #endif
        #ifdef AVMPLUS_ERROR_LANG_cs
            // cs
            {
                ...
                /*1516,140*/ "Condition cannot notify if associated mutex is not owned.",
                /*1517,141*/ "Condition cannot notifyAll if associated mutex is not owned.",
                /*2004,142*/ "Jeden z parametrů je neplatný.",
                /*2006,143*/ "Poskytnutý index je mimo rozsah.",
                /*2007,144*/ "Parametr %1 nesmí být null.",
                /*2008,145*/ "Parametr %1 musí být jedna z akceptovaných hodnot.",
                /*2012,146*/ "Pro třídu %1 nelze vytvořit instanci.",
                /*2030,147*/ "Bylo dosaženo konce souboru.",
                /*2058,148*/ "Při dekomprimování dat došlo k chybě.",
                /*2085,149*/ "Parametr %1 musí být neprázdný řetězec.",
                /*2088,150*/ "Třída Proxy neimplementuje funkci getProperty. Musí být přepsána podtřídou.",
                /*2089,151*/ "Třída Proxy neimplementuje funkci setProperty. Musí být přepsána podtřídou.",
                /*2090,152*/ "Třída Proxy neimplementuje funkci callProperty. Musí být přepsána podtřídou.",
                /*2091,153*/ "Třída Proxy neimplementuje funkci hasProperty. Musí být přepsána podtřídou.",
                /*2092,154*/ "Třída Proxy neimplementuje funkci deleteProperty. Musí být přepsána podtřídou.",
                /*2093,155*/ "Třída Proxy neimplementuje funkci getDescendants. Musí být přepsána podtřídou.",
                /*2105,156*/ "Třída Proxy neimplementuje funkci nextNameIndex. Musí být přepsána podtřídou.",
                /*2106,157*/ "Třída Proxy neimplementuje funkci nextName. Musí být přepsána podtřídou.",
                /*2107,158*/ "Třída Proxy neimplementuje funkci nextValue. Musí být přepsána podtřídou.",
                /*2108,159*/ "Hodnota %1 nepředstavuje platnou délku pole.",
                /*2173,160*/ "Nelze načíst objekt ve streamu.  Třída %1 neimplementuje rozhraní flash.utils.IExternalizable je však přesměrována na třídu externalizable."
            },
        #endif
        #ifdef AVMPLUS_ERROR_LANG_de
            // de
            {
                ...
                /*1516,140*/ "Condition cannot notify if associated mutex is not owned.",
                /*1517,141*/ "Condition cannot notifyAll if associated mutex is not owned.",
                /*2004,142*/ "Einer der Parameter ist ungültig.",
                /*2006,143*/ "Der angegebene Index liegt außerhalb des zulässigen Bereichs.",
                /*2007,144*/ "Parameter %1 darf nicht 'null' sein.",
                /*2008,145*/ "Parameter %1 muss einen zulässigen Wert haben.",
                /*2012,146*/ "%1-Klasse kann nicht instanziiert werden.",
                /*2030,147*/ "Das Dateiende wurde erkannt.",
                /*2058,148*/ "Fehler beim Dekomprimieren der Daten.",
                /*2085,149*/ "Parameter %1 darf kein leerer String sein.",
                /*2088,150*/ "Die Proxy-Klasse implementiert getProperty nicht. Sie muss von einer Unterklasse außer Kraft gesetzt werden.",
                /*2089,151*/ "Die Proxy-Klasse implementiert setProperty nicht. Sie muss von einer Unterklasse außer Kraft gesetzt werden.",
                /*2090,152*/ "Die Proxy-Klasse implementiert callProperty nicht. Sie muss von einer Unterklasse außer Kraft gesetzt werden.",
                /*2091,153*/ "Die Proxy-Klasse implementiert hasProperty nicht. Sie muss von einer Unterklasse außer Kraft gesetzt werden.",
                /*2092,154*/ "Die Proxy-Klasse implementiert deleteProperty nicht. Sie muss von einer Unterklasse außer Kraft gesetzt werden.",
                /*2093,155*/ "Die Proxy-Klasse implementiert getDescendants nicht. Sie muss von einer Unterklasse außer Kraft gesetzt werden.",
                /*2105,156*/ "Die Proxy-Klasse implementiert nextNameIndex nicht. Sie muss von einer Unterklasse außer Kraft gesetzt werden.",
                /*2106,157*/ "Die Proxy-Klasse implementiert nextName nicht. Sie muss von einer Unterklasse außer Kraft gesetzt werden.",
                /*2107,158*/ "Die Proxy-Klasse implementiert nextValue nicht. Sie muss von einer Unterklasse außer Kraft gesetzt werden.",
                /*2108,159*/ "Der Wert %1 ist keine gültige Arraylänge.",
                /*2173,160*/ "Das Objekt im Stream kann nicht gelesen werden.  Die %1-Klasse implementiert flash.utils.IExternalizable nicht, es erfolgt aber ein Aliasing in eine externalisierbare Klasse."
            },
        #endif
        #ifdef AVMPLUS_ERROR_LANG_es
            // es
            {
                ...
                /*1516,140*/ "Condition cannot notify if associated mutex is not owned.",
                /*1517,141*/ "Condition cannot notifyAll if associated mutex is not owned.",
                /*2004,142*/ "Uno de los parámetros no es válido.",
                /*2006,143*/ "El índice proporcionado está fuera de los límites.",
                /*2007,144*/ "El valor del parámetro %1 debe ser distinto de null.",
                /*2008,145*/ "El parámetro %1 debe tener uno de los valores aceptados.",
                /*2012,146*/ "No se puede crear una instancia de la clase %1.",
                /*2030,147*/ "Se alcanzó el final del archivo.",
                /*2058,148*/ "Se produjo un error al descomprimir los datos.",
                /*2085,149*/ "El parámetro %1 debe ser una cadena no vacía.",
                /*2088,150*/ "La clase Proxy no implementa getProperty. Debe sustituirse por una subclase.",
                /*2089,151*/ "La clase Proxy no implementa setProperty. Debe sustituirse por una subclase.",
                /*2090,152*/ "La clase Proxy no implementa callProperty. Debe sustituirse por una subclase.",
                /*2091,153*/ "La clase Proxy no implementa hasProperty. Debe sustituirse por una subclase.",
                /*2092,154*/ "La clase Proxy no implementa deleteProperty. Debe sustituirse por una subclase.",
                /*2093,155*/ "La clase Proxy no implementa getDescendants. Debe sustituirse por una subclase.",
                /*2105,156*/ "La clase Proxy no implementa nextNameIndex. Debe sustituirse por una subclase.",
                /*2106,157*/ "La clase Proxy no implementa nextName. Debe sustituirse por una subclase.",
                /*2107,158*/ "La clase Proxy no implementa nextValue. Debe sustituirse por una subclase.",
                /*2108,159*/ "El valor %1 no es un valor válido de longitud de conjunto.",
                /*2173,160*/ "No se puede leer el objeto del flujo.  La clase %1 no implementa flash.utils.IExternalizable pero está asociada a una clase externalizable."
            },
        #endif
        #ifdef AVMPLUS_ERROR_LANG_fr
            // fr
            {
                ...
                /*1516,140*/ "Condition cannot notify if associated mutex is not owned.",
                /*1517,141*/ "Condition cannot notifyAll if associated mutex is not owned.",
                /*2004,142*/ "L'un des paramètres n'est pas valide.",
                /*2006,143*/ "L'index indiqué sort des limites.",
                /*2007,144*/ "Le paramètre %1 ne doit pas être nul.",
                /*2008,145*/ "Le paramètre %1 doit être l'une des valeurs acceptées.",
                /*2012,146*/ "Impossible d'instancier la classe %1.",
                /*2030,147*/ "Fin de fichier détectée.",
                /*2058,148*/ "Une erreur s'est produite lors de la décompression des données.",
                /*2085,149*/ "Le paramètre %1 doit être une chaîne non vide.",
                /*2088,150*/ "La classe Proxy ne met pas en oeuvre getProperty. Elle doit être remplacée par une sous-classe.",
                /*2089,151*/ "La classe Proxy ne met pas en oeuvre setProperty. Elle doit être remplacée par une sous-classe.",
                /*2090,152*/ "La classe Proxy ne met pas en oeuvre callProperty. Elle doit être remplacée par une sous-classe.",
                /*2091,153*/ "La classe Proxy ne met pas en oeuvre hasProperty. Elle doit être remplacée par une sous-classe.",
                /*2092,154*/ "La classe Proxy ne met pas en oeuvre deleteProperty. Elle doit être remplacée par une sous-classe.",
                /*2093,155*/ "La classe Proxy ne met pas en oeuvre getDescendants. Elle doit être remplacée par une sous-classe.",
                /*2105,156*/ "La classe Proxy ne met pas en oeuvre nextNameIndex. Elle doit être remplacée par une sous-classe.",
                /*2106,157*/ "La classe Proxy ne met pas en oeuvre nextName. Elle doit être remplacée par une sous-classe.",
                /*2107,158*/ "La classe Proxy ne met pas en oeuvre nextValue. Elle doit être remplacée par une sous-classe.",
                /*2108,159*/ "La valeur %1 n’est pas une valeur de tableau valide.",
                /*2173,160*/ "Impossible de lire l'objet dans le flux. La classe %1 n'implémente pas flash.utils.IExternalizable, mais est aliasée vers une classe externalisable."
            },
        #endif
        #ifdef AVMPLUS_ERROR_LANG_it
            // it
            {
                ...
                /*1516,140*/ "Condition cannot notify if associated mutex is not owned.",
                /*1517,141*/ "Condition cannot notifyAll if associated mutex is not owned.",
                /*2004,142*/ "Uno dei parametri non è valido.",
                /*2006,143*/ "L'indice fornito è fuori intervallo.",
                /*2007,144*/ "Il valore del parametro %1 deve essere diverso da null.",
                /*2008,145*/ "Il valore del parametro %1 deve essere uno dei valori accettati.",
                /*2012,146*/ "Impossibile creare un'istanza della classe %1.",
                /*2030,147*/ "È stata raggiunta la fine del file.",
                /*2058,148*/ "Si è verificato un errore durante la decompressione dei dati.",
                /*2085,149*/ "Il parametro %1 deve essere una stringa non vuota.",
                /*2088,150*/ "La classe Proxy non implementa getProperty. Deve essere sostituita da una sottoclasse.",
                /*2089,151*/ "La classe Proxy non implementa setProperty. Deve essere sostituita da una sottoclasse.",
                /*2090,152*/ "La classe Proxy non implementa callProperty. Deve essere sostituita da una sottoclasse.",
                /*2091,153*/ "La classe Proxy non implementa hasProperty. Deve essere sostituita da una sottoclasse.",
                /*2092,154*/ "La classe Proxy non implementa deleteProperty. Deve essere sostituita da una sottoclasse.",
                /*2093,155*/ "La classe Proxy non implementa getDescendants. Deve essere sostituita da una sottoclasse.",
                /*2105,156*/ "La classe Proxy non implementa nextNameIndex. Deve essere sostituita da una sottoclasse.",
                /*2106,157*/ "La classe Proxy non implementa nextName. Deve essere sostituita da una sottoclasse.",
                /*2107,158*/ "La classe Proxy non implementa nextValue. Deve essere sostituita da una sottoclasse.",
                /*2108,159*/ "Il valore %1 non è una lunghezza array valida.",
                /*2173,160*/ "Impossibile leggere l'oggetto nel flusso.  La classe %1 non implementa flash.utils.IExternalizable ma è impostata come alias di una classe esternalizzabile."
            },
        #endif
        #ifdef AVMPLUS_ERROR_LANG_ja
            // ja
            {
                ...
                /*1516,140*/ "Condition cannot notify if associated mutex is not owned.",
                /*1517,141*/ "Condition cannot notifyAll if associated mutex is not owned.",
                /*2004,142*/ "パラメーターの 1 つが無効です。",
                /*2006,143*/ "指定したインデックスが境界外です。",
                /*2007,144*/ "パラメーター %1 は null 以外でなければなりません。",
                /*2008,145*/ "パラメーター %1 は承認された値の 1 つでなければなりません。",
                /*2012,146*/ "%1 クラスをインスタンス化することはできません。",
                /*2030,147*/ "ファイルの終端 (EOF) が検出されました。",
                /*2058,148*/ "圧縮データの解凍時にエラーが発生しました。",
                /*2085,149*/ "パラメーター %1 は空白以外の文字列でなければなりません。",
                /*2088,150*/ "Proxy クラスは、getProperty を実装しません。サブクラスでオーバーライドする必要があります。",
                /*2089,151*/ "Proxy クラスは、setProperty を実装しません。サブクラスでオーバーライドする必要があります。",
                /*2090,152*/ "Proxy クラスは、callProperty を実装しません。サブクラスでオーバーライドする必要があります。",
                /*2091,153*/ "Proxy クラスは、hasProperty を実装しません。サブクラスでオーバーライドする必要があります。",
                /*2092,154*/ "Proxy クラスは、deleteProperty を実装しません。サブクラスでオーバーライドする必要があります。",
                /*2093,155*/ "Proxy クラスは、getDescendants を実装しません。サブクラスでオーバーライドする必要があります。",
                /*2105,156*/ "Proxy クラスは、nextNameIndex を実装しません。サブクラスでオーバーライドする必要があります。",
                /*2106,157*/ "Proxy クラスは、nextName を実装しません。サブクラスでオーバーライドする必要があります。",
                /*2107,158*/ "Proxy クラスは、nextValue を実装しません。サブクラスでオーバーライドする必要があります。",
                /*2108,159*/ "値 %1 は有効な配列の長さではありません。",
                /*2173,160*/ "ストリーム内のオブジェクトを読み取れません。クラス %1 は flash.utils.IExternalizable を実装しませんが、外部化可能なクラスにエイリアス処理されます。"
            },
        #endif
        #ifdef AVMPLUS_ERROR_LANG_ko
            // ko
            {
                ...
                /*1516,140*/ "Condition cannot notify if associated mutex is not owned.",
                /*1517,141*/ "Condition cannot notifyAll if associated mutex is not owned.",
                /*2004,142*/ "매개 변수 중 하나가 유효하지 않습니다.",
                /*2006,143*/ "제공된 인덱스가 범위를 벗어났습니다.",
                /*2007,144*/ "매개 변수 %1은(는) null이 아니어야 합니다.",
                /*2008,145*/ "매개 변수 %1은(는) 허용된 값 중 하나여야 합니다.",
                /*2012,146*/ "%1 클래스를 인스턴스화할 수 없습니다.",
                /*2030,147*/ "파일의 끝입니다.",
                /*2058,148*/ "데이터의 압축을 푸는 동안 오류가 발생했습니다.",
                /*2085,149*/ "매개 변수 %1은(는) 비어 있지 않은 문자열이어야 합니다.",
                /*2088,150*/ "Proxy 클래스는 getProperty를 구현하지 않습니다. 하위 클래스에 의해 재정의되어야 합니다.",
                /*2089,151*/ "Proxy 클래스는 setProperty를 구현하지 않습니다. 하위 클래스에 의해 재정의되어야 합니다.",
                /*2090,152*/ "Proxy 클래스는 callProperty를 구현하지 않습니다. 하위 클래스에 의해 재정의되어야 합니다.",
                /*2091,153*/ "Proxy 클래스는 hasProperty를 구현하지 않습니다. 하위 클래스에 의해 재정의되어야 합니다.",
                /*2092,154*/ "Proxy 클래스는 deleteProperty를 구현하지 않습니다. 하위 클래스에 의해 재정의되어야 합니다.",
                /*2093,155*/ "Proxy 클래스는 getDescendants를 구현하지 않습니다. 하위 클래스에 의해 재정의되어야 합니다.",
                /*2105,156*/ "Proxy 클래스는 nextNameIndex를 구현하지 않습니다. 하위 클래스에 의해 재정의되어야 합니다.",
                /*2106,157*/ "Proxy 클래스는 nextName을 구현하지 않습니다. 하위 클래스에 의해 재정의되어야 합니다.",
                /*2107,158*/ "Proxy 클래스는 nextValue를 구현하지 않습니다. 하위 클래스에 의해 재정의되어야 합니다.",
                /*2108,159*/ "값 %1은(는) 유효한 배열 길이가 아닙니다.",
                /*2173,160*/ "스트림에서 객체를 읽을 수 없습니다.  클래스 %1은(는) flash.utils.IExternalizable을 구현하지 않지만 외부화할 수 있는 클래스에 앨리어스됩니다."
            },
        #endif
        #ifdef AVMPLUS_ERROR_LANG_nl
            // nl
            {
                ...
                /*1516,140*/ "Condition cannot notify if associated mutex is not owned.",
                /*1517,141*/ "Condition cannot notifyAll if associated mutex is not owned.",
                /*2004,142*/ "Een van de parameters is ongeldig.",
                /*2006,143*/ "De opgegeven index is buiten de grenzen.",
                /*2007,144*/ "Parameter %1 mag niet null zijn.",
                /*2008,145*/ "Parameter %1 moet een van de toegestane waarden zijn.",
                /*2012,146*/ "Klasse %1 kan niet worden geïnstantieerd.",
                /*2030,147*/ "Einde van bestand is bereikt.",
                /*2058,148*/ "Er is een fout opgetreden bij het decomprimeren van gegevens.",
                /*2085,149*/ "Parameter %1 mag geen lege tekenreeks zijn.",
                /*2088,150*/ "De klasse Proxy implementeert getProperty niet. Het moet worden overschreven door een subklasse.",
                /*2089,151*/ "De klasse Proxy implementeert setProperty niet. Het moet worden overschreven door een subklasse.",
                /*2090,152*/ "De klasse Proxy implementeert callProperty niet. Het moet worden overschreven door een subklasse.",
                /*2091,153*/ "De klasse Proxy implementeert hasProperty niet. Het moet worden overschreven door een subklasse.",
                /*2092,154*/ "De klasse Proxy implementeert deleteProperty niet. Het moet worden overschreven door een subklasse.",
                /*2093,155*/ "De klasse Proxy implementeert getDescendants niet. Het moet worden overschreven door een subklasse.",
                /*2105,156*/ "De klasse Proxy implementeert nextNameIndex niet. Het moet worden overschreven door een subklasse.",
                /*2106,157*/ "De klasse Proxy implementeert nextName niet. Het moet worden overschreven door een subklasse.",
                /*2107,158*/ "De klasse Proxy implementeert nextValue niet. Het moet worden overschreven door een subklasse.",
                /*2108,159*/ "De waarde %1 is geen geldige Array-lengte.",
                /*2173,160*/ "Kan object in stream niet lezen.  De klasse %1 implementeert flash.utils.IExternalizable niet, maar heeft een externaliseerbare klasse als alias."
            },
        #endif
        #ifdef AVMPLUS_ERROR_LANG_pl
            // pl
            {
                ...
                /*1516,140*/ "Condition cannot notify if associated mutex is not owned.",
                /*1517,141*/ "Condition cannot notifyAll if associated mutex is not owned.",
                /*2004,142*/ "Jeden z parametrów jest nieprawidłowy.",
                /*2006,143*/ "Określony indeks wychodzi poza zakres.",
                /*2007,144*/ "Parametr %1 musi mieć wartość inną niż null.",
                /*2008,145*/ "Parametr %1 musi być jedną z akceptowanych wartości.",
                /*2012,146*/ "Nie można utworzyć instancji klasy %1.",
                /*2030,147*/ "Napotkano koniec pliku.",
                /*2058,148*/ "Podczas dekompresji danych wystąpił błąd.",
                /*2085,149*/ "Parametr %1 musi być niepustym ciągiem.",
                /*2088,150*/ "Klasa Proxy nie implementuje metody getProperty. Należy ją przesłonić w podklasie.",
                /*2089,151*/ "Klasa Proxy nie implementuje metody setProperty. Należy ją przesłonić w podklasie.",
                /*2090,152*/ "Klasa Proxy nie implementuje metody callProperty. Należy ją przesłonić w podklasie.",
                /*2091,153*/ "Klasa Proxy nie implementuje metody hasProperty. Należy ją przesłonić w podklasie.",
                /*2092,154*/ "Klasa Proxy nie implementuje metody deleteProperty. Należy ją przesłonić w podklasie.",
                /*2093,155*/ "Klasa Proxy nie implementuje metody getDescendants. Należy ją przesłonić w podklasie.",
                /*2105,156*/ "Klasa Proxy nie implementuje metody nextNameIndex. Należy ją przesłonić w podklasie.",
                /*2106,157*/ "Klasa Proxy nie implementuje metody nextName. Należy ją przesłonić w podklasie.",
                /*2107,158*/ "Klasa Proxy nie implementuje metody nextValue. Należy ją przesłonić w podklasie.",
                /*2108,159*/ "Wartość %1 nie jest prawidłową długością tablicy.",
                /*2173,160*/ "Nie można odczytać obiektu w strumieniu.  Klasa %1 nie implementuje metody flash.utils.IExternalizable, ale ma alias dla klasy możliwej do uzewnętrznienia."
            },
        #endif
        #ifdef AVMPLUS_ERROR_LANG_cs
            // pt
            {
                ...
                /*1516,140*/ "Condition cannot notify if associated mutex is not owned.",
                /*1517,141*/ "Condition cannot notifyAll if associated mutex is not owned.",
                /*2004,142*/ "Um dos parâmetros é inválido.",
                /*2006,143*/ "O índice fornecido está fora dos limites.",
                /*2007,144*/ "O parâmetro %1 não deve ser nulo.",
                /*2008,145*/ "O parâmetro %1 deve ser um dos valores aceitos.",
                /*2012,146*/ "A classe %1 não pode ser instanciada.",
                /*2030,147*/ "O fim do arquivo foi encontrado.",
                /*2058,148*/ "Erro ao descompactar os dados.",
                /*2085,149*/ "O parâmetro %1 não deve ser uma string vazia.",
                /*2088,150*/ "A classe Proxy não implementa getProperty. Ela deve ser substituída por uma subclasse.",
                /*2089,151*/ "A classe Proxy não implementa setProperty. Ela deve ser substituída por uma subclasse.",
                /*2090,152*/ "A classe Proxy não implementa callProperty. Ela deve ser substituída por uma subclasse.",
                /*2091,153*/ "A classe Proxy não implementa hasProperty. Ela deve ser substituída por uma subclasse.",
                /*2092,154*/ "A classe Proxy não implementa deleteProperty. Ela deve ser substituída por uma subclasse.",
                /*2093,155*/ "A classe Proxy não implementa getDescendants. Ela deve ser substituída por uma subclasse.",
                /*2105,156*/ "A classe Proxy não implementa nextNameIndex. Ela deve ser substituída por uma subclasse.",
                /*2106,157*/ "A classe Proxy não implementa nextName. Ela deve ser substituída por uma subclasse.",
                /*2107,158*/ "A classe Proxy não implementa nextValue. Ela deve ser substituída por uma subclasse.",
                /*2108,159*/ "O valor %1 não é um comprimento de matriz válido.",
                /*2173,160*/ "Impossível ler o objeto em um fluxo. A classe %1 não implementa flash.utils.IExternalizable mas recebeu como alias uma classe externalizável."
            },
        #endif
        #ifdef AVMPLUS_ERROR_LANG_ru
            // ru
            {
                ...
                /*1516,140*/ "Condition cannot notify if associated mutex is not owned.",
                /*1517,141*/ "Condition cannot notifyAll if associated mutex is not owned.",
                /*2004,142*/ "Один из параметров указан неверно.",
                /*2006,143*/ "Предоставленный индекс выходит за допустимые пределы.",
                /*2007,144*/ "Параметр %1 не должен быть равен нулю.",
                /*2008,145*/ "Параметр %1 должен быть одним из принятых значений.",
                /*2012,146*/ "Класс %1 не может быть создан.",
                /*2030,147*/ "Обнаружен конец файла.",
                /*2058,148*/ "Ошибка при распаковке данных.",
                /*2085,149*/ "Параметр %1 должен быть не пустой строкой.",
                /*2088,150*/ "Класс Proxy не поддерживает getProperty. Он должен быть заменен на подкласс.",
                /*2089,151*/ "Класс Proxy не поддерживает setProperty. Он должен быть заменен на подкласс.",
                /*2090,152*/ "Класс Proxy не поддерживает callProperty. Он должен быть заменен на подкласс.",
                /*2091,153*/ "Класс Proxy не поддерживает hasProperty. Он должен быть заменен на подкласс.",
                /*2092,154*/ "Класс Proxy не поддерживает deleteProperty. Он должен быть заменен на подкласс.",
                /*2093,155*/ "Класс Proxy не поддерживает getDescendants. Он должен быть заменен на подкласс.",
                /*2105,156*/ "Класс Proxy не поддерживает nextNameIndex. Он должен быть заменен на подкласс.",
                /*2106,157*/ "Класс Proxy не поддерживает nextName. Он должен быть заменен на подкласс.",
                /*2107,158*/ "Класс Proxy не поддерживает nextValue. Он должен быть заменен на подкласс.",
                /*2108,159*/ "Значение %1 не является допустимой длиной массива.",
                /*2173,160*/ "Не удается прочитать объект в потоке. В классе %1 не реализован интерфейс flash.utils.Iexternalizable, но в качестве его псевдонима используется класс с поддержкой внешних связей."
            },
        #endif
        #ifdef AVMPLUS_ERROR_LANG_sv
            // sv
            {
                ...
                /*1516,140*/ "Condition cannot notify if associated mutex is not owned.",
                /*1517,141*/ "Condition cannot notifyAll if associated mutex is not owned.",
                /*2004,142*/ "En av parametrarna är ogiltig.",
                /*2006,143*/ "Det angivna indexvärdet är utanför intervallet.",
                /*2007,144*/ "Parametern %1 får inte vara null.",
                /*2008,145*/ "Parametern %1 måste ha ett av de godkända värdena.",
                /*2012,146*/ "Det går inte att skapa en förekomst av klassen %1.",
                /*2030,147*/ "Filens slut påträffades.",
                /*2058,148*/ "Ett fel uppstod vid dekomprimering av data.",
                /*2085,149*/ "Parametern %1 får inte vara en tom sträng.",
                /*2088,150*/ "Klassen Proxy implementerar inte getProperty. Den måste åsidosättas av en underordnad klass.",
                /*2089,151*/ "Klassen Proxy implementerar inte setProperty. Den måste åsidosättas av en underordnad klass.",
                /*2090,152*/ "Klassen Proxy implementerar inte callProperty. Den måste åsidosättas av en underordnad klass.",
                /*2091,153*/ "Klassen Proxy implementerar inte hasProperty. Den måste åsidosättas av en underordnad klass.",
                /*2092,154*/ "Klassen Proxy implementerar inte deleteProperty. Den måste åsidosättas av en underordnad klass.",
                /*2093,155*/ "Klassen Proxy implementerar inte getDescendants. Den måste åsidosättas av en underordnad klass.",
                /*2105,156*/ "Klassen Proxy implementerar inte nextNameIndex. Den måste åsidosättas av en underordnad klass.",
                /*2106,157*/ "Klassen Proxy implementerar inte nextName. Den måste åsidosättas av en underordnad klass.",
                /*2107,158*/ "Klassen Proxy implementerar inte nextValue. Den måste åsidosättas av en underordnad klass.",
                /*2108,159*/ "Värdet %1 är ingen giltig Array-längd.",
                /*2173,160*/ "Det gick inte att läsa objektet i flödet. Klassen %1 implementerar inte flash.utils.IExternalizable men har en extern klass som alias."
            },
        #endif
        #ifdef AVMPLUS_ERROR_LANG_tr
            // tr
            {
                ...
                /*1516,140*/ "Condition cannot notify if associated mutex is not owned.",
                /*1517,141*/ "Condition cannot notifyAll if associated mutex is not owned.",
                /*2004,142*/ "Parametrelerden biri geçersiz.",
                /*2006,143*/ "Sağlanan dizin sınırların dışındadır.",
                /*2007,144*/ "%1 parametresi boş olmamalıdır.",
                /*2008,145*/ "%1 parametresi kabul edilen değerlerden biridir.",
                /*2012,146*/ "%1 sınıfı örneklendirilemiyor.",
                /*2030,147*/ "Dosya sonuyla karşılaşıldı.",
                /*2058,148*/ "Veri açılırken hata oluştu.",
                /*2085,149*/ "%1 parametresi boş olmayan dizgi olmalıdır.",
                /*2088,150*/ "Proxy sınıfı getProperty uygulayamaz. Bir alt sınıf ile geçersiz kılınmalıdır.",
                /*2089,151*/ "Proxy sınıfı setProperty uygulayamaz. Bir alt sınıf ile geçersiz kılınmalıdır.",
                /*2090,152*/ "Proxy sınıfı callProperty uygulayamaz. Bir alt sınıf ile geçersiz kılınmalıdır.",
                /*2091,153*/ "Proxy sınıfı hasProperty uygulayamaz. Bir alt sınıf ile geçersiz kılınmalıdır.",
                /*2092,154*/ "Proxy sınıfı deleteProperty uygulayamaz. Bir alt sınıf ile geçersiz kılınmalıdır.",
                /*2093,155*/ "Proxy sınıfı getDescendants uygulayamaz. Bir alt sınıf ile geçersiz kılınmalıdır.",
                /*2105,156*/ "Proxy sınıfı nextNameIndex uygulayamaz. Bir alt sınıf ile geçersiz kılınmalıdır.",
                /*2106,157*/ "Proxy sınıfı nextName uygulayamaz. Bir alt sınıf ile geçersiz kılınmalıdır.",
                /*2107,158*/ "Proxy sınıfı nextValue uygulayamaz. Bir alt sınıf ile geçersiz kılınmalıdır.",
                /*2108,159*/ "%1 değeri geçerli bir Dizi uzunluğu değil.",
                /*2173,160*/ "Akıştaki nesne okunamıyor.  %1 sınıfı, flash.utils.IExternalizable öğesini uygulamıyor, ancak haricileştirebilir bir sınıfın adıyla biliniyor."
            },
        #endif
        #ifdef AVMPLUS_ERROR_LANG_zh_CN
            // zh_CN
            {
                ...
                /*2006,143*/ "提供的索引超出范围。",
                /*2007,144*/ "参数 %1 不能为空。",
                /*2008,145*/ "参数 %1 必须是某个可接受的值。",
                /*2012,146*/ "无法实例化 %1 类。",
                /*2030,147*/ "遇到文件尾。",
                /*2058,148*/ "解压缩数据时出错。",
                /*2085,149*/ "参数 %1 必须为非空字符串。",
                /*2088,150*/ "Proxy 类不实现 getProperty。它必须由一个子类覆盖。",
                /*2089,151*/ "Proxy 类不实现 setProperty。它必须由一个子类覆盖。",
                /*2090,152*/ "Proxy 类不实现 callProperty。它必须由一个子类覆盖。",
                /*2091,153*/ "Proxy 类不实现 hasProperty。它必须由一个子类覆盖。",
                /*2092,154*/ "Proxy 类不实现 deleteProperty。它必须由一个子类覆盖。",
                /*2093,155*/ "Proxy 类不实现 getDescendants。它必须由一个子类覆盖。",
                /*2105,156*/ "Proxy 类不实现 nextNameIndex。它必须由一个子类覆盖。",
                /*2106,157*/ "Proxy 类不实现 nextName。它必须由一个子类覆盖。",
                /*2107,158*/ "Proxy 类不实现 nextValue。它必须由一个子类覆盖。",
                /*2108,159*/ "值 %1 不是有效的数组长度。",
                /*2173,160*/ "无法读取流中的对象。类 %1 虽未实现 flash.utils.IExternalizable，但由其别名可得知它为 externalizable 类。"
            },
        #endif
        #ifdef AVMPLUS_ERROR_LANG_zh_TW
            // zh_TW
            {
                ...
                /*2004,142*/ "有一個參數無效。",
                /*2006,143*/ "提供的索引超出範圍。",
                /*2007,144*/ "參數 %1 不能是 Null。",
                /*2008,145*/ "參數 %1 必須是其中一個可接受值。",
                /*2012,146*/ "無法個體化類別 %1。",
                /*2030,147*/ "到達檔案結尾。",
                /*2058,148*/ "解壓縮資料時發生錯誤。",
                /*2085,149*/ "參數 %1 必須是空字串。",
                /*2088,150*/ "Proxy 類別不會實作 getProperty。它必須以子類別覆寫。",
                /*2089,151*/ "Proxy 類別不會實作 setProperty。它必須以子類別覆寫。",
                /*2090,152*/ "Proxy 類別不會實作 callProperty。它必須以子類別覆寫。",
                /*2091,153*/ "Proxy 類別不會實作 hasProperty。它必須以子類別覆寫。",
                /*2092,154*/ "Proxy 類別不會實作 deleteProperty。它必須以子類別覆寫。",
                /*2093,155*/ "Proxy 類別不會實作 getDescendants。它必須以子類別覆寫。",
                /*2105,156*/ "Proxy 類別不會實作 nextNameIndex。它必須以子類別覆寫。",
                /*2106,157*/ "Proxy 類別不會實作 nextName。它必須以子類別覆寫。",
                /*2107,158*/ "Proxy 類別不會實作 nextValue。它必須以子類別覆寫。",
                /*2108,159*/ "值 %1 不是有效的陣列長度。",
                /*2173,160*/ "無法讀取串流中的物件。類別 %1 未實作 flash.utils.IExternalizable，卻已別名化為可外部化的類別。"
            }
        #endif
        };
