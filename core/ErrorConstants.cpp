    ...
    namespace ErrorConstants
    {
        ...
        const char* errorConstants[kLanguages][kNumErrorConstants] =
        {
                // en
            {
                ...
                /*1500,120*/ "Error occurred opening file %1.",
                /*1501,121*/ "Error occurred writing to file %1.",
                /*1502,122*/ "A script has executed for longer than the default timeout period of 15 seconds.",
                /*1503,123*/ "A script failed to exit after 30 seconds and was terminated.",
                /*1504,124*/ "End of file.",
                /*1505,125*/ "The string index %1 is out of bounds; must be in range %2 to %3.",
                /*1506,126*/ "The specified range is invalid.",
                /*1507,127*/ "Argument %1 cannot be null.",
                /*1508,128*/ "The value specified for argument %1 is invalid.",
                /*1509,129*/ "There was an error decompressing the data.",
                /*1510,130*/ "When the callback argument is a method of a class, the optional this argument must be null."
            },
                // de
            {
                ...
                /*1125,118*/ "The index %1 is out of range %2.",
                /*1126,119*/ "Cannot change the length of a fixed Vector.",
                /*1500,120*/ "Fehler beim Öffnen von Datei %1.",
                /*1501,121*/ "Fehler beim Schreiben in Datei %1.",
                /*1502,122*/ "Ein Skript wurde länger als die Standard-Timeout-Zeit von 15 Sekunden ausgeführt.",
                /*1503,123*/ "Ein Skript konnte nach 30 Sekunden nicht abgeschlossen werden und wurde beendet.",
                /*1504,124*/ "Dateiende.",
                /*1505,125*/ "Der String-Index %1 liegt außerhalb des zulässigen Bereichs; muss im Bereich %2 bis %3 liegen.",
                /*1506,126*/ "Der angegebene Bereich ist ungültig.",
                /*1507,127*/ "Argument %1 kann nicht null sein.",
                /*1508,128*/ "Der angegebene Wert für Argument %1 ist ungültig.",
                /*1509,129*/ "Fehler beim Dekomprimieren der Daten.",
                /*1510,130*/ "Wenn das callback-Argument eine Methode einer Klasse ist, muss das optionale this-Argument null sein."
            },
                // es
            {
                ...
                /*1125,118*/ "The index %1 is out of range %2.",
                /*1126,119*/ "Cannot change the length of a fixed Vector.",
                /*1500,120*/ "Error al abrir el archivo %1.",
                /*1501,121*/ "Error al escribir en el archivo %1.",
                /*1502,122*/ "El tiempo de ejecución del script ha superado el tiempo de espera predeterminado de 15 segundos.",
                /*1503,123*/ "No se salió del script en 30 segundos y se ha cerrado.",
                /*1504,124*/ "Final del archivo.",
                /*1505,125*/ "El índice de cadena %1 está fuera de los límites; debe estar en el rango %2-%3.",
                /*1506,126*/ "El rango especificado no es válido.",
                /*1507,127*/ "El argumento %1 no puede ser null.",
                /*1508,128*/ "El valor especificado para el argumento %1 no es válido.",
                /*1509,129*/ "Se produjo un error al descomprimir los datos.",
                /*1510,130*/ "Si el argumento de la función de repetición de llamada es un método de la clase, el argumento opcional debe ser null."
            },
                // fr
            {
                ...
                /*1125,118*/ "The index %1 is out of range %2.",
                /*1126,119*/ "Cannot change the length of a fixed Vector.",
                /*1500,120*/ "Une erreur s’est produite lors de l’ouverture du fichier %1.",
                /*1501,121*/ "Une erreur s’est produite lors de l’écriture dans le fichier %1.",
                /*1502,122*/ "La durée d'exécution d'un script excède le délai par défaut (15 secondes).",
                /*1503,123*/ "Un script ne s'est pas terminé après 30 secondes et a été arrêté.",
                /*1504,124*/ "Fin du fichier.",
                /*1505,125*/ "L'index de chaîne %1 sort des limites. Il doit être compris entre %2 et %3.",
                /*1506,126*/ "La plage indiquée n'est pas valide.",
                /*1507,127*/ "L’argument %1 ne doit pas être null.",
                /*1508,128*/ "La valeur indiquée pour l’argument %1 n’est pas valide.",
                /*1509,129*/ "Une erreur s'est produite lors de la décompression des données.",
                /*1510,130*/ "Lorsque l’argument du rappel correspond à une méthode de classe, l’argument facultatif 'this' doit être null."
            },
                // it
            {
                ...
                /*1125,118*/ "The index %1 is out of range %2.",
                /*1126,119*/ "Cannot change the length of a fixed Vector.",
                /*1500,120*/ "Errore durante l'apertura del file %1.",
                /*1501,121*/ "Errore durante la scrittura del file %1.",
                /*1502,122*/ "Uno script è stato eseguito per più del periodo di timeout predefinito di 15 secondi.",
                /*1503,123*/ "Uno script non è uscito dopo 30 secondi ed è stato terminato.",
                /*1504,124*/ "Fine del file.",
                /*1505,125*/ "L'indice di stringa %1 è fuori dei limiti; deve essere compreso nell'intervallo da %2 a %3.",
                /*1506,126*/ "L'intervallo specificato non è valido.",
                /*1507,127*/ "L'argomento %1 non può essere null.",
                /*1508,128*/ "Il valore specificato per l'argomento %1 non è valido.",
                /*1509,129*/ "Si è verificato un errore durante la decompressione dei dati.",
                /*1510,130*/ "Quando l'argomento callback è il metodo di una classe, l'argomento opzionale this deve essere null."
            },
                // ja
            {
                /*1000,0*/ "システムのメモリ不足です。",
                ...
                /*1125,118*/ "The index %1 is out of range %2.",
                /*1126,119*/ "Cannot change the length of a fixed Vector.",
                /*1500,120*/ "ファイル %1 を開く際にエラーが発生しました。",
                /*1501,121*/ "ファイル %1 に書き込む際にエラーが発生しました。",
                /*1502,122*/ "スクリプトがデフォルトのタイムアウト時間の 15 秒を超えて実行されました。",
                /*1503,123*/ "スクリプトが 30 秒後の終了に失敗したため、強制終了しました。",
                /*1504,124*/ "ファイルの終端です。",
                /*1505,125*/ "文字列インデックス %1 が境界外です。%2 ～ %3 の範囲内である必要があります。",
                /*1506,126*/ "指定した範囲は無効です。",
                /*1507,127*/ "引数 %1 は null にすることができません。",
                /*1508,128*/ "引数 %1 に指定した値は無効です。",
                /*1509,129*/ "圧縮データの解凍時にエラーが発生しました。",
                /*1510,130*/ "コールバック引数がクラスのメソッドのとき、任意指定の引数 'this' は null でなければなりません。"
            },
                // ko
            {
                ...
                /*1125,118*/ "The index %1 is out of range %2.",
                /*1126,119*/ "Cannot change the length of a fixed Vector.",
                /*1500,120*/ "파일 %1을(를) 여는 동안 오류가 발생했습니다.",
                /*1501,121*/ "파일 %1에 쓰는 동안 오류가 발생했습니다.",
                /*1502,122*/ "스크립트 실행 시간이 기본 제한 시간인 15초를 초과했습니다.",
                /*1503,123*/ "스크립트가 30초 후에도 끝나지 않아 종료했습니다.",
                /*1504,124*/ "파일의 끝입니다.",
                /*1505,125*/ "문자열 인덱스 %1이(가) 범위를 벗어났습니다. %2와 %3 사이의 범위에 있어야 합니다.",
                /*1506,126*/ "유효하지 않은 범위가 지정되었습니다.",
                /*1507,127*/ "인수 %1은(는) null일 수 없습니다.",
                /*1508,128*/ "인수 %1에 지정된 값이 유효하지 않습니다.",
                /*1509,129*/ "데이터의 압축을 푸는 동안 오류가 발생했습니다.",
                /*1510,130*/ "콜백 인수가 클래스의 메서드인 경우 선택적 인수 'this'는 null이어야 합니다."
            },
                // zh_CN
            {
                /*1000,0*/ "系统内存不足。",
                ...
                /*1500,120*/ "打开文件 %1 时出错。",
                /*1501,121*/ "写入文件 %1 时出错。",
                /*1502,122*/ "脚本的执行时间已经超过了 15 秒的默认超时设置。",
                /*1503,123*/ "脚本未能在 30 秒后退出而被终止。",
                /*1504,124*/ "文件结尾。",
                /*1505,125*/ "字符串索引 %1 超出范围；必须在 %2 到 %3 的范围内。",
                /*1506,126*/ "指定的范围无效。",
                /*1507,127*/ "参数 %1 不能为空。",
                /*1508,128*/ "为参数 %1 指定的值无效。",
                /*1509,129*/ "解压缩数据时出错。",
                /*1510,130*/ "如果回调参数是某个类的方法，则可选参数“this”必须为空。"
            },
                // zh_TW
            {
                /*1000,0*/ "系統記憶體不足。",
                ...
                /*1125,118*/ "The index %1 is out of range %2.",
                /*1126,119*/ "Cannot change the length of a fixed Vector.",
                /*1500,120*/ "開啟檔案 %1 時發生錯誤。",
                /*1501,121*/ "寫入檔案 %1 時發生錯誤。",
                /*1502,122*/ "script 已經執行超過預設的 15 秒逾時時段。",
                /*1503,123*/ "Script 並未在 30 秒後結束，已經被終止。",
                /*1504,124*/ "檔案結尾。",
                /*1505,125*/ "字串索引 %1 超出範圍；範圍必須介於 %2 到 %3。",
                /*1506,126*/ "指定的範圍無效。",
                /*1507,127*/ "引數 %1 不能是 null。",
                /*1508,128*/ "指定給引數 %1 的值無效。",
                /*1509,129*/ "解壓縮資料時發生錯誤。",
                /*1510,130*/ "若回呼引數是 Class 的方法，選擇性的引數 'this' 必須是 null。"
            }
        };
        #endif /* DEBUGGER */
    }
