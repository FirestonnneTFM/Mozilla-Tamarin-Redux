    ...
    namespace ErrorConstants
    {
        ...
        const char* errorConstants[][kNumErrorConstants] =
        {
            ...
            // en
            {
                ...
                /*2004,135*/ "One of the parameters is invalid.",
                /*2006,136*/ "The supplied index is out of bounds.",
                /*2007,137*/ "Parameter %1 must be non-null.",
                /*2008,138*/ "Parameter %1 must be one of the accepted values.",
                /*2012,139*/ "%1 class cannot be instantiated.",
                /*2030,140*/ "End of file was encountered.",
                /*2058,141*/ "There was an error decompressing the data.",
                /*2085,142*/ "Parameter %1 must be non-empty string.",
                /*2088,143*/ "The Proxy class does not implement getProperty. It must be overridden by a subclass.",
                /*2089,144*/ "The Proxy class does not implement setProperty. It must be overridden by a subclass.",
                /*2090,145*/ "The Proxy class does not implement callProperty. It must be overridden by a subclass.",
                /*2091,146*/ "The Proxy class does not implement hasProperty. It must be overridden by a subclass.",
                /*2092,147*/ "The Proxy class does not implement deleteProperty. It must be overridden by a subclass.",
                /*2093,148*/ "The Proxy class does not implement getDescendants. It must be overridden by a subclass.",
                /*2105,149*/ "The Proxy class does not implement nextNameIndex. It must be overridden by a subclass.",
                /*2106,150*/ "The Proxy class does not implement nextName. It must be overridden by a subclass.",
                /*2107,151*/ "The Proxy class does not implement nextValue. It must be overridden by a subclass.",
                /*2108,152*/ "The value %1 is not a valid Array length.",
                /*2173,153*/ "Unable to read object in stream.  The class %1 does not implement flash.utils.IExternalizable but is aliased to an externalizable class."
            },
        #endif
        #ifdef AVMPLUS_ERROR_LANG_cs
            // cs
            {
                ...
                /*2004,135*/ "Jeden z parametrů je neplatný.",
                /*2006,136*/ "Poskytnutý index je mimo rozsah.",
                /*2007,137*/ "Parametr %1 nesmí být null.",
                /*2008,138*/ "Parametr %1 musí být jedna z akceptovaných hodnot.",
                /*2012,139*/ "Pro třídu %1 nelze vytvořit instanci.",
                /*2030,140*/ "Bylo dosaženo konce souboru.",
                /*2058,141*/ "Při dekomprimování dat došlo k chybě.",
                /*2085,142*/ "Parametr %1 musí být neprázdný řetězec.",
                /*2088,143*/ "Třída Proxy neimplementuje funkci getProperty. Musí být přepsána podtřídou.",
                /*2089,144*/ "Třída Proxy neimplementuje funkci setProperty. Musí být přepsána podtřídou.",
                /*2090,145*/ "Třída Proxy neimplementuje funkci callProperty. Musí být přepsána podtřídou.",
                /*2091,146*/ "Třída Proxy neimplementuje funkci hasProperty. Musí být přepsána podtřídou.",
                /*2092,147*/ "Třída Proxy neimplementuje funkci deleteProperty. Musí být přepsána podtřídou.",
                /*2093,148*/ "Třída Proxy neimplementuje funkci getDescendants. Musí být přepsána podtřídou.",
            ...
            // de
            {
                ...
                /*2004,135*/ "Einer der Parameter ist ungültig.",
                /*2006,136*/ "Der angegebene Index liegt außerhalb des zulässigen Bereichs.",
                /*2007,137*/ "Parameter %1 darf nicht 'null' sein.",
                /*2008,138*/ "Parameter %1 muss einen zulässigen Wert haben.",
                /*2012,139*/ "%1-Klasse kann nicht instanziiert werden.",
                /*2030,140*/ "Das Dateiende wurde erkannt.",
                /*2058,141*/ "Fehler beim Dekomprimieren der Daten.",
                /*2085,142*/ "Parameter %1 darf kein leerer String sein.",
                /*2088,143*/ "Die Proxy-Klasse implementiert getProperty nicht. Sie muss von einer Unterklasse außer Kraft gesetzt werden.",
                /*2089,144*/ "Die Proxy-Klasse implementiert setProperty nicht. Sie muss von einer Unterklasse außer Kraft gesetzt werden.",
                /*2090,145*/ "Die Proxy-Klasse implementiert callProperty nicht. Sie muss von einer Unterklasse außer Kraft gesetzt werden.",
                /*2091,146*/ "Die Proxy-Klasse implementiert hasProperty nicht. Sie muss von einer Unterklasse außer Kraft gesetzt werden.",
                /*2092,147*/ "Die Proxy-Klasse implementiert deleteProperty nicht. Sie muss von einer Unterklasse außer Kraft gesetzt werden.",
                /*2093,148*/ "Die Proxy-Klasse implementiert getDescendants nicht. Sie muss von einer Unterklasse außer Kraft gesetzt werden.",
            ...
            // es
            {
                ...
                /*2004,135*/ "Uno de los parámetros no es válido.",
                /*2006,136*/ "El índice proporcionado está fuera de los límites.",
                /*2007,137*/ "El valor del parámetro %1 debe ser distinto de null.",
                /*2008,138*/ "El parámetro %1 debe tener uno de los valores aceptados.",
                /*2012,139*/ "No se puede crear una instancia de la clase %1.",
                /*2030,140*/ "Se alcanzó el final del archivo.",
                /*2058,141*/ "Se produjo un error al descomprimir los datos.",
                /*2085,142*/ "El parámetro %1 debe ser una cadena no vacía.",
                /*2088,143*/ "La clase Proxy no implementa getProperty. Debe sustituirse por una subclase.",
                /*2089,144*/ "La clase Proxy no implementa setProperty. Debe sustituirse por una subclase.",
                /*2090,145*/ "La clase Proxy no implementa callProperty. Debe sustituirse por una subclase.",
                /*2091,146*/ "La clase Proxy no implementa hasProperty. Debe sustituirse por una subclase.",
                /*2092,147*/ "La clase Proxy no implementa deleteProperty. Debe sustituirse por una subclase.",
                /*2093,148*/ "La clase Proxy no implementa getDescendants. Debe sustituirse por una subclase.",
            ...
            // fr
            {
                ...
                /*2004,135*/ "L'un des paramètres n'est pas valide.",
                /*2006,136*/ "L'index indiqué sort des limites.",
                /*2007,137*/ "Le paramètre %1 ne doit pas être nul.",
                /*2008,138*/ "Le paramètre %1 doit être l'une des valeurs acceptées.",
                /*2012,139*/ "Impossible d'instancier la classe %1.",
                /*2030,140*/ "Fin de fichier détectée.",
                /*2058,141*/ "Une erreur s'est produite lors de la décompression des données.",
                /*2085,142*/ "Le paramètre %1 doit être une chaîne non vide.",
                /*2088,143*/ "La classe Proxy ne met pas en oeuvre getProperty. Elle doit être remplacée par une sous-classe.",
                /*2089,144*/ "La classe Proxy ne met pas en oeuvre setProperty. Elle doit être remplacée par une sous-classe.",
                /*2090,145*/ "La classe Proxy ne met pas en oeuvre callProperty. Elle doit être remplacée par une sous-classe.",
                /*2091,146*/ "La classe Proxy ne met pas en oeuvre hasProperty. Elle doit être remplacée par une sous-classe.",
                /*2092,147*/ "La classe Proxy ne met pas en oeuvre deleteProperty. Elle doit être remplacée par une sous-classe.",
                /*2093,148*/ "La classe Proxy ne met pas en oeuvre getDescendants. Elle doit être remplacée par une sous-classe.",
            ...
            // it
            {
                ...
                /*2004,135*/ "Uno dei parametri non è valido.",
                /*2006,136*/ "L'indice fornito è fuori intervallo.",
                /*2007,137*/ "Il valore del parametro %1 deve essere diverso da null.",
                /*2008,138*/ "Il valore del parametro %1 deve essere uno dei valori accettati.",
                /*2012,139*/ "Impossibile creare un'istanza della classe %1.",
                /*2030,140*/ "È stata raggiunta la fine del file.",
                /*2058,141*/ "Si è verificato un errore durante la decompressione dei dati.",
                /*2085,142*/ "Il parametro %1 deve essere una stringa non vuota.",
                /*2088,143*/ "La classe Proxy non implementa getProperty. Deve essere sostituita da una sottoclasse.",
                /*2089,144*/ "La classe Proxy non implementa setProperty. Deve essere sostituita da una sottoclasse.",
                /*2090,145*/ "La classe Proxy non implementa callProperty. Deve essere sostituita da una sottoclasse.",
                /*2091,146*/ "La classe Proxy non implementa hasProperty. Deve essere sostituita da una sottoclasse.",
                /*2092,147*/ "La classe Proxy non implementa deleteProperty. Deve essere sostituita da una sottoclasse.",
                /*2093,148*/ "La classe Proxy non implementa getDescendants. Deve essere sostituita da una sottoclasse.",
            ...
            // ja
            {
                ...
                /*2004,135*/ "パラメーターの 1 つが無効です。",
                /*2006,136*/ "指定したインデックスが境界外です。",
                /*2007,137*/ "パラメーター %1 は null 以外でなければなりません。",
                /*2008,138*/ "パラメーター %1 は承認された値の 1 つでなければなりません。",
                /*2012,139*/ "%1 クラスをインスタンス化することはできません。",
                /*2030,140*/ "ファイルの終端 (EOF) が検出されました。",
                /*2058,141*/ "圧縮データの解凍時にエラーが発生しました。",
                /*2085,142*/ "パラメーター %1 は空白以外の文字列でなければなりません。",
                /*2088,143*/ "Proxy クラスは、getProperty を実装しません。サブクラスでオーバーライドする必要があります。",
                /*2089,144*/ "Proxy クラスは、setProperty を実装しません。サブクラスでオーバーライドする必要があります。",
                /*2090,145*/ "Proxy クラスは、callProperty を実装しません。サブクラスでオーバーライドする必要があります。",
                /*2091,146*/ "Proxy クラスは、hasProperty を実装しません。サブクラスでオーバーライドする必要があります。",
                /*2092,147*/ "Proxy クラスは、deleteProperty を実装しません。サブクラスでオーバーライドする必要があります。",
                /*2093,148*/ "Proxy クラスは、getDescendants を実装しません。サブクラスでオーバーライドする必要があります。",
            ...
            // ko
            {
                ...
                /*2004,135*/ "매개 변수 중 하나가 유효하지 않습니다.",
                /*2006,136*/ "제공된 인덱스가 범위를 벗어났습니다.",
                /*2007,137*/ "매개 변수 %1은(는) null이 아니어야 합니다.",
                /*2008,138*/ "매개 변수 %1은(는) 허용된 값 중 하나여야 합니다.",
                /*2012,139*/ "%1 클래스를 인스턴스화할 수 없습니다.",
                /*2030,140*/ "파일의 끝입니다.",
                /*2058,141*/ "데이터의 압축을 푸는 동안 오류가 발생했습니다.",
                /*2085,142*/ "매개 변수 %1은(는) 비어 있지 않은 문자열이어야 합니다.",
                /*2088,143*/ "Proxy 클래스는 getProperty를 구현하지 않습니다. 하위 클래스에 의해 재정의되어야 합니다.",
                /*2089,144*/ "Proxy 클래스는 setProperty를 구현하지 않습니다. 하위 클래스에 의해 재정의되어야 합니다.",
                /*2090,145*/ "Proxy 클래스는 callProperty를 구현하지 않습니다. 하위 클래스에 의해 재정의되어야 합니다.",
                /*2091,146*/ "Proxy 클래스는 hasProperty를 구현하지 않습니다. 하위 클래스에 의해 재정의되어야 합니다.",
                /*2092,147*/ "Proxy 클래스는 deleteProperty를 구현하지 않습니다. 하위 클래스에 의해 재정의되어야 합니다.",
                /*2093,148*/ "Proxy 클래스는 getDescendants를 구현하지 않습니다. 하위 클래스에 의해 재정의되어야 합니다.",
            ...
            // nl
            {
                ...
                /*2004,135*/ "Een van de parameters is ongeldig.",
                /*2006,136*/ "De opgegeven index is buiten de grenzen.",
                /*2007,137*/ "Parameter %1 mag niet null zijn.",
                /*2008,138*/ "Parameter %1 moet een van de toegestane waarden zijn.",
                /*2012,139*/ "Klasse %1 kan niet worden geïnstantieerd.",
                /*2030,140*/ "Einde van bestand is bereikt.",
                /*2058,141*/ "Er is een fout opgetreden bij het decomprimeren van gegevens.",
                /*2085,142*/ "Parameter %1 mag geen lege tekenreeks zijn.",
                /*2088,143*/ "De klasse Proxy implementeert getProperty niet. Het moet worden overschreven door een subklasse.",
                /*2089,144*/ "De klasse Proxy implementeert setProperty niet. Het moet worden overschreven door een subklasse.",
                /*2090,145*/ "De klasse Proxy implementeert callProperty niet. Het moet worden overschreven door een subklasse.",
                /*2091,146*/ "De klasse Proxy implementeert hasProperty niet. Het moet worden overschreven door een subklasse.",
                /*2092,147*/ "De klasse Proxy implementeert deleteProperty niet. Het moet worden overschreven door een subklasse.",
                /*2093,148*/ "De klasse Proxy implementeert getDescendants niet. Het moet worden overschreven door een subklasse.",
            ...
            // pl
            {
                ...
                /*2004,135*/ "Jeden z parametrów jest nieprawidłowy.",
                /*2006,136*/ "Określony indeks wychodzi poza zakres.",
                /*2007,137*/ "Parametr %1 musi mieć wartość inną niż null.",
                /*2008,138*/ "Parametr %1 musi być jedną z akceptowanych wartości.",
                /*2012,139*/ "Nie można utworzyć instancji klasy %1.",
                /*2030,140*/ "Napotkano koniec pliku.",
                /*2058,141*/ "Podczas dekompresji danych wystąpił błąd.",
                /*2085,142*/ "Parametr %1 musi być niepustym ciągiem.",
                /*2088,143*/ "Klasa Proxy nie implementuje metody getProperty. Należy ją przesłonić w podklasie.",
                /*2089,144*/ "Klasa Proxy nie implementuje metody setProperty. Należy ją przesłonić w podklasie.",
                /*2090,145*/ "Klasa Proxy nie implementuje metody callProperty. Należy ją przesłonić w podklasie.",
                /*2091,146*/ "Klasa Proxy nie implementuje metody hasProperty. Należy ją przesłonić w podklasie.",
                /*2092,147*/ "Klasa Proxy nie implementuje metody deleteProperty. Należy ją przesłonić w podklasie.",
                /*2093,148*/ "Klasa Proxy nie implementuje metody getDescendants. Należy ją przesłonić w podklasie.",
            ...
            // pt
            {
                ...
                /*2004,135*/ "Um dos parâmetros é inválido.",
                /*2006,136*/ "O índice fornecido está fora dos limites.",
                /*2007,137*/ "O parâmetro %1 não deve ser nulo.",
                /*2008,138*/ "O parâmetro %1 deve ser um dos valores aceitos.",
                /*2012,139*/ "A classe %1 não pode ser instanciada.",
                /*2030,140*/ "O fim do arquivo foi encontrado.",
                /*2058,141*/ "Erro ao descompactar os dados.",
                /*2085,142*/ "O parâmetro %1 não deve ser uma string vazia.",
                /*2088,143*/ "A classe Proxy não implementa getProperty. Ela deve ser substituída por uma subclasse.",
                /*2089,144*/ "A classe Proxy não implementa setProperty. Ela deve ser substituída por uma subclasse.",
                /*2090,145*/ "A classe Proxy não implementa callProperty. Ela deve ser substituída por uma subclasse.",
                /*2091,146*/ "A classe Proxy não implementa hasProperty. Ela deve ser substituída por uma subclasse.",
                /*2092,147*/ "A classe Proxy não implementa deleteProperty. Ela deve ser substituída por uma subclasse.",
                /*2093,148*/ "A classe Proxy não implementa getDescendants. Ela deve ser substituída por uma subclasse.",
            ...
            // ru
            {
                ...
                /*2004,135*/ "Один из параметров указан неверно.",
                /*2006,136*/ "Предоставленный индекс выходит за допустимые пределы.",
                /*2007,137*/ "Параметр %1 не должен быть равен нулю.",
                /*2008,138*/ "Параметр %1 должен быть одним из принятых значений.",
                /*2012,139*/ "Класс %1 не может быть создан.",
                /*2030,140*/ "Обнаружен конец файла.",
                /*2058,141*/ "Ошибка при распаковке данных.",
                /*2085,142*/ "Параметр %1 должен быть не пустой строкой.",
                /*2088,143*/ "Класс Proxy не поддерживает getProperty. Он должен быть заменен на подкласс.",
                /*2089,144*/ "Класс Proxy не поддерживает setProperty. Он должен быть заменен на подкласс.",
                /*2090,145*/ "Класс Proxy не поддерживает callProperty. Он должен быть заменен на подкласс.",
                /*2091,146*/ "Класс Proxy не поддерживает hasProperty. Он должен быть заменен на подкласс.",
                /*2092,147*/ "Класс Proxy не поддерживает deleteProperty. Он должен быть заменен на подкласс.",
                /*2093,148*/ "Класс Proxy не поддерживает getDescendants. Он должен быть заменен на подкласс.",
            ...
            // sv
            {
                ...
                /*2004,135*/ "En av parametrarna är ogiltig.",
                /*2006,136*/ "Det angivna indexvärdet är utanför intervallet.",
                /*2007,137*/ "Parametern %1 får inte vara null.",
                /*2008,138*/ "Parametern %1 måste ha ett av de godkända värdena.",
                /*2012,139*/ "Det går inte att skapa en förekomst av klassen %1.",
                /*2030,140*/ "Filens slut påträffades.",
                /*2058,141*/ "Ett fel uppstod vid dekomprimering av data.",
                /*2085,142*/ "Parametern %1 får inte vara en tom sträng.",
                /*2088,143*/ "Klassen Proxy implementerar inte getProperty. Den måste åsidosättas av en underordnad klass.",
                /*2089,144*/ "Klassen Proxy implementerar inte setProperty. Den måste åsidosättas av en underordnad klass.",
                /*2090,145*/ "Klassen Proxy implementerar inte callProperty. Den måste åsidosättas av en underordnad klass.",
                /*2091,146*/ "Klassen Proxy implementerar inte hasProperty. Den måste åsidosättas av en underordnad klass.",
                /*2092,147*/ "Klassen Proxy implementerar inte deleteProperty. Den måste åsidosättas av en underordnad klass.",
                /*2093,148*/ "Klassen Proxy implementerar inte getDescendants. Den måste åsidosättas av en underordnad klass.",
            ...
            // tr
            {
                ...
                /*2004,135*/ "Parametrelerden biri geçersiz.",
                /*2006,136*/ "Sağlanan dizin sınırların dışındadır.",
                /*2007,137*/ "%1 parametresi boş olmamalıdır.",
                /*2008,138*/ "%1 parametresi kabul edilen değerlerden biridir.",
                /*2012,139*/ "%1 sınıfı örneklendirilemiyor.",
                /*2030,140*/ "Dosya sonuyla karşılaşıldı.",
                /*2058,141*/ "Veri açılırken hata oluştu.",
                /*2085,142*/ "%1 parametresi boş olmayan dizgi olmalıdır.",
                /*2088,143*/ "Proxy sınıfı getProperty uygulayamaz. Bir alt sınıf ile geçersiz kılınmalıdır.",
                /*2089,144*/ "Proxy sınıfı setProperty uygulayamaz. Bir alt sınıf ile geçersiz kılınmalıdır.",
                /*2090,145*/ "Proxy sınıfı callProperty uygulayamaz. Bir alt sınıf ile geçersiz kılınmalıdır.",
                /*2091,146*/ "Proxy sınıfı hasProperty uygulayamaz. Bir alt sınıf ile geçersiz kılınmalıdır.",
                /*2092,147*/ "Proxy sınıfı deleteProperty uygulayamaz. Bir alt sınıf ile geçersiz kılınmalıdır.",
                /*2093,148*/ "Proxy sınıfı getDescendants uygulayamaz. Bir alt sınıf ile geçersiz kılınmalıdır.",
            ...
            // zh_CN
            {
                ...
                /*2006,136*/ "提供的索引超出范围。",
                /*2007,137*/ "参数 %1 不能为空。",
                /*2008,138*/ "参数 %1 必须是某个可接受的值。",
                /*2012,139*/ "无法实例化 %1 类。",
                /*2030,140*/ "遇到文件尾。",
                /*2058,141*/ "解压缩数据时出错。",
                /*2085,142*/ "参数 %1 必须为非空字符串。",
                /*2088,143*/ "Proxy 类不实现 getProperty。它必须由一个子类覆盖。",
                /*2089,144*/ "Proxy 类不实现 setProperty。它必须由一个子类覆盖。",
                /*2090,145*/ "Proxy 类不实现 callProperty。它必须由一个子类覆盖。",
                /*2091,146*/ "Proxy 类不实现 hasProperty。它必须由一个子类覆盖。",
                /*2092,147*/ "Proxy 类不实现 deleteProperty。它必须由一个子类覆盖。",
                /*2093,148*/ "Proxy 类不实现 getDescendants。它必须由一个子类覆盖。",
            ...
            // zh_TW
            {
                ...
                /*2004,135*/ "有一個參數無效。",
                /*2006,136*/ "提供的索引超出範圍。",
                /*2007,137*/ "參數 %1 不能是 Null。",
                /*2008,138*/ "參數 %1 必須是其中一個可接受值。",
                /*2012,139*/ "無法個體化類別 %1。",
                /*2030,140*/ "到達檔案結尾。",
                /*2058,141*/ "解壓縮資料時發生錯誤。",
                /*2085,142*/ "參數 %1 必須是空字串。",
                /*2088,143*/ "Proxy 類別不會實作 getProperty。它必須以子類別覆寫。",
                /*2089,144*/ "Proxy 類別不會實作 setProperty。它必須以子類別覆寫。",
                /*2090,145*/ "Proxy 類別不會實作 callProperty。它必須以子類別覆寫。",
                /*2091,146*/ "Proxy 類別不會實作 hasProperty。它必須以子類別覆寫。",
                /*2092,147*/ "Proxy 類別不會實作 deleteProperty。它必須以子類別覆寫。",
                /*2093,148*/ "Proxy 類別不會實作 getDescendants。它必須以子類別覆寫。",
