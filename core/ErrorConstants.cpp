    ...
    namespace ErrorConstants
    {
        ...
        const char* errorConstants[][kNumErrorConstants] =
        {
            ...
            // en
            {
                ...
                /*2006,135*/ "The supplied index is out of bounds.",
                /*2007,136*/ "Parameter %1 must be non-null.",
            ...
            // cs
            {
                ...
                /*2006,135*/ "Poskytnutý index je mimo rozsah.",
                /*2007,136*/ "Parametr %1 nesmí být null.",
            ...
            // de
            {
                ...
                /*2006,135*/ "Der angegebene Index liegt außerhalb des zulässigen Bereichs.",
                /*2007,136*/ "Parameter %1 darf nicht 'null' sein.",
            ...
            // es
            {
                ...
                /*2006,135*/ "El índice proporcionado está fuera de los límites.",
                /*2007,136*/ "El valor del parámetro %1 debe ser distinto de null.",
            ...
            // fr
            {
                ...
                /*2006,135*/ "L'index indiqué sort des limites.",
                /*2007,136*/ "Le paramètre %1 ne doit pas être nul.",
            ...
            // it
            {
                ...
                /*2006,135*/ "L'indice fornito è fuori intervallo.",
                /*2007,136*/ "Il valore del parametro %1 deve essere diverso da null.",
            ...
            // ja
            {
                ...
                /*2006,135*/ "指定したインデックスが境界外です。",
                /*2007,136*/ "パラメーター %1 は null 以外でなければなりません。",
            ...
            // ko
            {
                ...
                /*2006,135*/ "제공된 인덱스가 범위를 벗어났습니다.",
                /*2007,136*/ "매개 변수 %1은(는) null이 아니어야 합니다.",
            ...
            // nl
            {
                ...
                /*2006,135*/ "De opgegeven index is buiten de grenzen.",
                /*2007,136*/ "Parameter %1 mag niet null zijn.",
            ...
            // pl
            {
                ...
                /*2006,135*/ "Określony indeks wychodzi poza zakres.",
                /*2007,136*/ "Parametr %1 musi mieć wartość inną niż null.",
            ...
            // pt
            {
                ...
                /*2006,135*/ "O índice fornecido está fora dos limites.",
                /*2007,136*/ "O parâmetro %1 não deve ser nulo.",
            ...
            // ru
            {
                ...
                /*2006,135*/ "Предоставленный индекс выходит за допустимые пределы.",
                /*2007,136*/ "Параметр %1 не должен быть равен нулю.",
            ...
            // sv
            {
                ...
                /*2006,135*/ "Det angivna indexvärdet är utanför intervallet.",
                /*2007,136*/ "Parametern %1 får inte vara null.",
            ...
            // tr
            {
                ...
                /*2006,135*/ "Sağlanan dizin sınırların dışındadır.",
                /*2007,136*/ "%1 parametresi boş olmamalıdır.",
