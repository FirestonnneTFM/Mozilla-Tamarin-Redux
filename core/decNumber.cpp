...
/* ------------------------------------------------------------------ */
extern char * decNumberToString(const decNumber *dn, char *string){
...
/* ------------------------------------------------------------------ */
/* decComp -- compare two decNumbers by numerical value               */
/*                                                                    */
...
/* ------------------------------------------------------------------ */
 int32_t decComp(const decNumber *lhs, const decNumber *rhs) {
	return decCompare(lhs, rhs, 0);
}
