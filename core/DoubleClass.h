...
#ifndef __avmplus_DoubleClass__
#define __avmplus_DoubleClass__
...
namespace avmplus
{
	 ...
	 * class double
	 */
    class DoubleClass : public ClassClosure
    {
	public:
		DoubleClass(VTable* cvtable);
