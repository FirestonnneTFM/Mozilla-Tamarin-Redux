...
os.system(asc+" -abcfuture -builtin -import ../core/builtin.abc -out toplevel toplevel.as Domain.as StringBuilder.as ByteArray.as FloatArray.as ShortArray.as UShortArray.as ../extensions/Sampler.as ../extensions/Trace.as ../extensions/Dictionary.as Endian.as Java.as")
