...
const uint32_t abcclass_avmplus_StringBuilder = 4;

const uint32_t abcclass_flash_utils_ByteArray = 5;
const uint32_t abcscript_stopSampling = 3;
const uint32_t abcscript_getSampleCount = 3;
...
const uint32_t abcscript_clearSamples = 3;
const uint32_t abcscript_pauseSampling = 3;

const uint32_t abcclass_flash_sampler_DeleteObjectSample = 9;

const uint32_t abcclass_flash_sampler_NewObjectSample = 8;

const uint32_t abcclass_flash_sampler_Sample = 7;

const uint32_t abcclass_flash_sampler_StackFrame = 6;

const uint32_t abcclass_flash_trace_Trace = 10;

const uint32_t abcclass_flash_utils_Dictionary = 11;

const uint32_t abcclass_flash_utils_Endian = 12;

const uint32_t abcclass_avmplus_JObject = 13;
...
extern AvmThunkRetType_AvmBox toplevel_a2a_os_rest_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_AvmBox toplevel_a2a_os_rest_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_int32_t toplevel_i2a_o_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_int32_t toplevel_i2a_o_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_AvmBox toplevel_a2a_o_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_AvmBox toplevel_a2a_o_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_AvmString toplevel_s2a_os_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_AvmString toplevel_s2a_os_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_void toplevel_v2a_oss_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_void toplevel_v2a_oss_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_void toplevel_v2a_oouu_opti0_opti0_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_void toplevel_v2a_oouu_opti0_opti0_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_AvmBox toplevel_a2a_oii_opti2_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_AvmBox toplevel_a2a_oii_opti2_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_AvmBox toplevel_a2a_ooio_optakAvmThunkNull_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_AvmBox toplevel_a2a_ooio_optakAvmThunkNull_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_void toplevel_v2a_ouu_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_void toplevel_v2a_ouu_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_double toplevel_d2d_o_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_double toplevel_d2d_o_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_AvmString toplevel_s2a_os_rest_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_AvmString toplevel_s2a_os_rest_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_int32_t toplevel_i2a_oi_opti2_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_int32_t toplevel_i2a_oi_opti2_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_int32_t toplevel_i2a_osu_opti0_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_int32_t toplevel_i2a_osu_opti0_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_void toplevel_v2a_ouus_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_void toplevel_v2a_ouus_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_AvmBox toplevel_a2a_ob_optbfalse_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_AvmBox toplevel_a2a_ob_optbfalse_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_int32_t toplevel_i2a_osu_optu4294967295U_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_int32_t toplevel_i2a_osu_optu4294967295U_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_void toplevel_v2a_od_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_void toplevel_v2a_od_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_bool toplevel_b2a_oao_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_bool toplevel_b2a_oao_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_AvmBox toplevel_a2a_ou_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_AvmBox toplevel_a2a_ou_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_void toplevel_v2a_ous_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_void toplevel_v2a_ous_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_AvmString toplevel_s2a_o_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_AvmString toplevel_s2a_o_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  ...
  #define avmplus_System_getAvmplusVersion_thunk  toplevel_s2a_o_thunk
  #define avmplus_System_getAvmplusVersion_thunkc toplevel_s2a_o_thunkc
...
extern AvmThunkRetType_uint32_t toplevel_u2a_o_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_uint32_t toplevel_u2a_o_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_void toplevel_v2a_oo_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_void toplevel_v2a_oo_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t avmplus_System_trace = 10;
  #define avmplus_System_trace_thunk  toplevel_v2a_oo_thunk
  #define avmplus_System_trace_thunkc toplevel_v2a_oo_thunkc
extern AvmThunkRetType_void toplevel_v2a_o_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_void toplevel_v2a_o_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_bool toplevel_b2a_o_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_bool toplevel_b2a_o_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_double toplevel_d2d_oaou_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_double toplevel_d2d_oaou_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_AvmString toplevel_s2a_oos_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_AvmString toplevel_s2a_oos_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_AvmString toplevel_s2a_oos_rest_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_AvmString toplevel_s2a_oos_rest_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_void toplevel_v2a_oi_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_void toplevel_v2a_oi_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_void toplevel_v2a_oa_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_void toplevel_v2a_oa_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_void toplevel_v2a_os_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_void toplevel_v2a_os_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  ...
  #define avmplus_System_write_thunk  toplevel_v2a_os_thunk
  #define avmplus_System_write_thunkc toplevel_v2a_os_thunkc
extern AvmThunkRetType_AvmString toplevel_s2a_ouu_optu4294967295U_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_AvmString toplevel_s2a_ouu_optu4294967295U_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_AvmBox toplevel_a2a_os_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_AvmBox toplevel_a2a_os_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_uint32_t toplevel_u2a_ou_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_uint32_t toplevel_u2a_ou_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_void toplevel_v2a_ob_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_void toplevel_v2a_ob_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_AvmBox toplevel_a2a_oo_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_AvmBox toplevel_a2a_oo_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_double toplevel_d2d_oa_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_double toplevel_d2d_oa_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_AvmBox toplevel_a2a_oab_optbfalse_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_AvmBox toplevel_a2a_oab_optbfalse_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_int32_t toplevel_i2a_os_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_int32_t toplevel_i2a_os_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t avmplus_System_exec = 8;
  #define avmplus_System_exec_thunk  toplevel_i2a_os_thunk
  #define avmplus_System_exec_thunkc toplevel_i2a_os_thunkc
extern AvmThunkRetType_void toplevel_v2a_ou_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_void toplevel_v2a_ou_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_AvmString toplevel_s2a_ou_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_AvmString toplevel_s2a_ou_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_void toplevel_v2a_oua_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_void toplevel_v2a_oua_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
