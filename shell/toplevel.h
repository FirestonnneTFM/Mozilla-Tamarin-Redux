...
extern AvmThunkRetType_void AVMTHUNK_CALLTYPE toplevel_v2a_oo_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
...
extern AvmThunkRetType_int32_t AVMTHUNK_CALLTYPE toplevel_i2a_os_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
