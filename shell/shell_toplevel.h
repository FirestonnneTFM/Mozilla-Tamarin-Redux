...
const uint32_t abcclass_avmshell_public_class_660 = 7;
const uint32_t abcclass_avmshell_public_class_661 = 8;
const uint32_t abcclass_avmshell_public_class_662 = 9;
const uint32_t abcclass_avmshell_public_class_663 = 10;
const uint32_t abcclass_avmshell_public_class_664 = 11;
const uint32_t abcclass_avmshell_public_class_665 = 12;
const uint32_t abcclass_avmshell_public_class_661_662 = 13;
const uint32_t abcclass_avmshell_public_class_666_660 = 14;
const uint32_t abcclass_avmshell_public_class_664_662_666 = 15;
const uint32_t abcclass_avmshell_public_class_665_660_661_662 = 16;
const uint32_t abcclass_avmshell_public_interface = 17;
const uint32_t abcclass_avmshell_public_interface_660 = 18;
const uint32_t abcclass_avmshell_public_interface_661 = 19;
const uint32_t abcclass_avmshell_public_interface_662 = 20;
const uint32_t abcclass_avmshell_public_interface_663 = 21;
const uint32_t abcclass_avmshell_public_interface_664 = 22;
const uint32_t abcclass_avmshell_public_interface_665 = 23;
const uint32_t abcclass_avmshell_public_interface_661_662 = 24;
const uint32_t abcclass_avmshell_public_interface_666_660 = 25;
const uint32_t abcclass_avmshell_public_interface_664_662_666 = 26;
const uint32_t abcclass_avmshell_public_interface_665_660_661_662 = 27;
const uint32_t abcclass_avmplus_Domain = 28;
const uint32_t abcclass_flash_sampler_StackFrame = 29;
const uint32_t abcclass_flash_sampler_Sample = 30;
const uint32_t abcclass_flash_sampler_NewObjectSample = 31;
const uint32_t abcclass_flash_sampler_DeleteObjectSample = 32;
const uint32_t abcclass_flash_trace_Trace = 33;
const uint32_t abcclass_flash_utils_Dictionary = 34;
const uint32_t abcclass_flash_utils_Endian = 35;
const uint32_t abcclass_avmplus_JObject = 36;
...
const uint32_t avmplus_System_getFeatures = 52;
const uint32_t avmplus_System_getRunmode = 53;
const uint32_t avmplus_System_trace = 54;
const uint32_t avmplus_System_write = 55;
const uint32_t avmplus_System_debugger = 56;
const uint32_t avmplus_System_isDebugger = 57;
const uint32_t avmplus_System_getTimer = 58;
const uint32_t avmplus_System_private_getArgv = 59;
const uint32_t avmplus_System_readLine = 60;
const uint32_t avmplus_System_totalMemory_get = 61;
const uint32_t avmplus_System_freeMemory_get = 62;
const uint32_t avmplus_System_privateMemory_get = 63;
const uint32_t avmplus_System_forceFullCollection = 64;
const uint32_t avmplus_System_queueCollection = 65;
const uint32_t avmplus_System_ns_example_nstest = 66;
const uint32_t avmplus_System_isGlobal = 67;
const uint32_t avmplus_System_swfVersion_get = 68;
const uint32_t avmplus_System_disposeXML = 69;
const uint32_t avmplus_File_exists = 72;
const uint32_t avmplus_File_read = 73;
const uint32_t avmplus_File_write = 74;
const uint32_t avmplus_File_readByteArray = 75;
const uint32_t avmplus_File_writeByteArray = 76;
const uint32_t avmplus_Domain_currentDomain_get = 161;
const uint32_t avmplus_Domain_MIN_DOMAIN_MEMORY_LENGTH_get = 162;
const uint32_t avmplus_Domain_private_init = 163;
const uint32_t avmplus_Domain_loadBytes = 165;
const uint32_t avmplus_Domain_getClass = 166;
const uint32_t avmplus_Domain_domainMemory_get = 168;
const uint32_t avmplus_Domain_domainMemory_set = 169;
const uint32_t native_script_function_flash_sampler_getMasterString = 171;
const uint32_t native_script_function_flash_sampler_getSavedThis = 172;
const uint32_t native_script_function_flash_sampler_getLexicalScopes = 173;
const uint32_t native_script_function_flash_sampler_isGetterSetter = 174;
const uint32_t native_script_function_flash_sampler__getInvocationCount = 175;
const uint32_t native_script_function_flash_sampler_getSampleCount = 179;
const uint32_t native_script_function_flash_sampler_getSamples = 180;
const uint32_t native_script_function_flash_sampler_getMemberNames = 181;
const uint32_t native_script_function_flash_sampler_getSize = 182;
const uint32_t native_script_function_flash_sampler__setSamplerCallback = 183;
const uint32_t native_script_function_flash_sampler_sampleInternalAllocs = 186;
const uint32_t native_script_function_flash_sampler_pauseSampling = 187;
const uint32_t native_script_function_flash_sampler_stopSampling = 188;
const uint32_t native_script_function_flash_sampler_startSampling = 189;
const uint32_t native_script_function_flash_sampler_clearSamples = 190;
const uint32_t flash_sampler_NewObjectSample_object_get = 197;
const uint32_t flash_sampler_NewObjectSample_size_get = 198;
const uint32_t flash_trace_Trace_setLevel = 204;
const uint32_t flash_trace_Trace_getLevel = 205;
const uint32_t flash_trace_Trace_setListener = 206;
const uint32_t flash_trace_Trace_getListener = 207;
const uint32_t flash_utils_Dictionary_private_init = 211;
const uint32_t avmplus_JObject_create = 218;
const uint32_t avmplus_JObject_createArray = 219;
const uint32_t avmplus_JObject_toArray = 220;
const uint32_t avmplus_JObject_constructorSignature = 221;
const uint32_t avmplus_JObject_methodSignature = 222;
const uint32_t avmplus_JObject_fieldSignature = 223;
