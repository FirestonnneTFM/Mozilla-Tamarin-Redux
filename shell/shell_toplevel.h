...
#define AVMTHUNK_VERSION 2
const uint32_t shell_toplevel_abc_class_count = 14;
const uint32_t shell_toplevel_abc_script_count = 9;
const uint32_t shell_toplevel_abc_method_count = 151;
const uint32_t shell_toplevel_abc_length = 5594;
extern const uint8_t shell_toplevel_abc_data[5594];
...
const uint32_t abcscript_flash_sampler_stopSampling = 3;
const uint32_t abcscript_flash_sampler_sampleInternalAllocs = 3;
const uint32_t abcscript_flash_sampler_getSampleCount = 3;
const uint32_t abcscript_flash_sampler_getSize = 3;
const uint32_t abcscript_flash_sampler_startSampling = 3;
const uint32_t abcscript_flash_sampler_getMemberNames = 3;
const uint32_t abcscript_flash_sampler_setSamplerCallback = 3;
const uint32_t abcscript_flash_sampler_isGetterSetter = 3;
const uint32_t abcscript_flash_sampler__getInvocationCount = 3;
const uint32_t abcscript_flash_sampler_getSamples = 3;
const uint32_t abcscript_flash_sampler_clearSamples = 3;
const uint32_t abcscript_flash_sampler_pauseSampling = 3;
...
extern AvmThunkRetType_AvmString AVMTHUNK_CALLTYPE shell_toplevel_s2a_oos_rest_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t avmplus_JObject_methodSignature = 146;
...
extern AvmThunkRetType_double AVMTHUNK_CALLTYPE shell_toplevel_d2d_o_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t flash_sampler_NewObjectSample_size_get = 123;
  ...
  const uint32_t flash_sampler_getSampleCount = 106;
  ...
  const uint32_t flash_utils_ByteArray_readFloat = 85;
  ...
  const uint32_t flash_utils_ByteArray_readDouble = 86;
...
extern AvmThunkRetType_void AVMTHUNK_CALLTYPE shell_toplevel_v2a_oouu_opti0_opti0_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t flash_utils_ByteArray_writeBytes = 68;
  ...
  const uint32_t flash_utils_ByteArray_readBytes = 67;
...
extern AvmThunkRetType_AvmBox AVMTHUNK_CALLTYPE shell_toplevel_a2a_os_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t flash_utils_ByteArray_readFile = 65;
  ...
  const uint32_t avmplus_Domain_getClass = 38;
...
extern AvmThunkRetType_uint32_t AVMTHUNK_CALLTYPE shell_toplevel_u2a_ou_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t avmplus_StringBuilder_charCodeAt = 48;
...
extern AvmThunkRetType_AvmBox AVMTHUNK_CALLTYPE shell_toplevel_a2a_ou_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t avmplus_StringBuilder_length_set = 54;
...
extern AvmThunkRetType_void AVMTHUNK_CALLTYPE shell_toplevel_v2a_oi_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t flash_utils_ByteArray_writeByte = 70;
  ...
  const uint32_t flash_utils_ByteArray_writeInt = 72;
  ...
  const uint32_t flash_utils_ByteArray_writeShort = 71;
...
extern AvmThunkRetType_AvmString AVMTHUNK_CALLTYPE shell_toplevel_s2a_o_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  ...
  const uint32_t avmplus_JObject_toString = 148;
  ...
  const uint32_t flash_utils_ByteArray_toString = 93;
  ...
  const uint32_t flash_utils_ByteArray_endian_get = 97;
  ...
  const uint32_t flash_utils_ByteArray_readUTF = 87;
  ...
  const uint32_t avmplus_StringBuilder_toString = 61;
...
extern AvmThunkRetType_AvmBoolArg AVMTHUNK_CALLTYPE shell_toplevel_b2a_oao_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t flash_sampler_isGetterSetter = 101;
...
extern AvmThunkRetType_int32_t AVMTHUNK_CALLTYPE shell_toplevel_i2a_oi_opti2_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t flash_trace_Trace_getLevel = 130;
...
extern AvmThunkRetType_void AVMTHUNK_CALLTYPE shell_toplevel_v2a_ous_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t avmplus_StringBuilder_setCharAt = 59;
...
extern AvmThunkRetType_uint32_t AVMTHUNK_CALLTYPE shell_toplevel_u2a_o_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t flash_utils_ByteArray_readUnsignedShort = 82;
  ...
  const uint32_t flash_utils_ByteArray_bytesAvailable_get = 94;
  ...
  const uint32_t flash_utils_ByteArray_length_get = 89;
  ...
  const uint32_t avmplus_StringBuilder_length_get = 53;
  ...
  const uint32_t flash_utils_ByteArray_readUnsignedInt = 84;
  ...
  const uint32_t flash_utils_ByteArray_readUnsignedByte = 80;
  ...
  const uint32_t avmplus_StringBuilder_capacity_get = 46;
  ...
  const uint32_t flash_utils_ByteArray_position_get = 95;
...
extern AvmThunkRetType_void AVMTHUNK_CALLTYPE shell_toplevel_v2a_ouu_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t avmplus_StringBuilder_remove = 55;
...
extern AvmThunkRetType_AvmBox AVMTHUNK_CALLTYPE shell_toplevel_a2a_ooio_optakAvmThunkNull_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t avmplus_JObject_createArray = 143;
...
extern AvmThunkRetType_AvmString AVMTHUNK_CALLTYPE shell_toplevel_s2a_os_rest_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t avmplus_JObject_constructorSignature = 145;
...
extern AvmThunkRetType_int32_t AVMTHUNK_CALLTYPE shell_toplevel_i2a_o_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t flash_utils_ByteArray_readInt = 83;
  ...
  const uint32_t flash_utils_ByteArray_readShort = 81;
  ...
  const uint32_t flash_utils_ByteArray_readByte = 79;
...
extern AvmThunkRetType_void AVMTHUNK_CALLTYPE shell_toplevel_v2a_oua_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t avmplus_StringBuilder_insert = 51;
...
extern AvmThunkRetType_AvmString AVMTHUNK_CALLTYPE shell_toplevel_s2a_oos_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t avmplus_JObject_fieldSignature = 147;
...
extern AvmThunkRetType_void AVMTHUNK_CALLTYPE shell_toplevel_v2a_ouus_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t avmplus_StringBuilder_replace = 57;
...
extern AvmThunkRetType_AvmString AVMTHUNK_CALLTYPE shell_toplevel_s2a_ou_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t avmplus_StringBuilder_charAt = 47;
  ...
  const uint32_t flash_utils_ByteArray_readUTFBytes = 88;
...
extern AvmThunkRetType_AvmBox AVMTHUNK_CALLTYPE shell_toplevel_a2a_os_rest_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t avmplus_JObject_create = 142;
...
extern AvmThunkRetType_AvmBoolArg AVMTHUNK_CALLTYPE shell_toplevel_b2a_o_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t flash_utils_ByteArray_readBoolean = 78;
...
extern AvmThunkRetType_AvmBox AVMTHUNK_CALLTYPE shell_toplevel_a2a_o_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t flash_sampler_getSamples = 107;
  ...
  const uint32_t flash_trace_Trace_getListener = 132;
  ...
  const uint32_t flash_sampler_NewObjectSample_object_get = 122;
  ...
  const uint32_t avmplus_Domain_domainMemory_get = 40;
...
extern AvmThunkRetType_AvmBox AVMTHUNK_CALLTYPE shell_toplevel_a2a_oab_optbtrue_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_AvmBox AVMTHUNK_CALLTYPE shell_toplevel_a2a_oab_optbtrue_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t flash_sampler_getMemberNames = 108;
  #define flash_sampler_getMemberNames_thunk  shell_toplevel_a2a_oab_optbtrue_thunk
  #define flash_sampler_getMemberNames_thunkc shell_toplevel_a2a_oab_optbtrue_thunkc
...
extern AvmThunkRetType_double AVMTHUNK_CALLTYPE shell_toplevel_d2d_oaou_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t flash_sampler__getInvocationCount = 102;
...
extern AvmThunkRetType_int32_t AVMTHUNK_CALLTYPE shell_toplevel_i2a_osu_optu4294967295U_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t avmplus_StringBuilder_lastIndexOf = 52;
...
extern AvmThunkRetType_void AVMTHUNK_CALLTYPE shell_toplevel_v2a_od_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t flash_utils_ByteArray_writeFloat = 74;
  ...
  const uint32_t flash_utils_ByteArray_writeDouble = 75;
...
extern AvmThunkRetType_AvmString AVMTHUNK_CALLTYPE shell_toplevel_s2a_ouu_optu4294967295U_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t avmplus_StringBuilder_substring = 60;
...
extern AvmThunkRetType_void AVMTHUNK_CALLTYPE shell_toplevel_v2a_ob_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  ...
  const uint32_t flash_sampler_sampleInternalAllocs = 111;
...
extern AvmThunkRetType_void AVMTHUNK_CALLTYPE shell_toplevel_v2a_oa_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t avmplus_StringBuilder_append = 45;
...
extern AvmThunkRetType_double AVMTHUNK_CALLTYPE shell_toplevel_d2d_oa_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t flash_sampler_getSize = 109;
...
extern AvmThunkRetType_void AVMTHUNK_CALLTYPE shell_toplevel_v2a_oo_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  ...
  const uint32_t flash_sampler_setSamplerCallback = 110;
...
extern AvmThunkRetType_int32_t AVMTHUNK_CALLTYPE shell_toplevel_i2a_osu_opti0_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t avmplus_StringBuilder_indexOf = 50;
...
extern AvmThunkRetType_AvmBox AVMTHUNK_CALLTYPE shell_toplevel_a2a_ob_optbtrue_thunk(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
extern AvmThunkRetType_AvmBox AVMTHUNK_CALLTYPE shell_toplevel_a2a_ob_optbtrue_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t flash_utils_Dictionary_Dictionary = 136;
  #define flash_utils_Dictionary_Dictionary_thunk  shell_toplevel_a2a_ob_optbtrue_thunk
  #define flash_utils_Dictionary_Dictionary_thunkc shell_toplevel_a2a_ob_optbtrue_thunkc
...
extern AvmThunkRetType_void AVMTHUNK_CALLTYPE shell_toplevel_v2a_o_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t flash_utils_ByteArray_uncompress = 92;
  ...
  const uint32_t flash_sampler_startSampling = 114;
  ...
  const uint32_t flash_sampler_pauseSampling = 112;
  ...
  const uint32_t flash_sampler_clearSamples = 115;
  ...
  const uint32_t flash_sampler_stopSampling = 113;
  ...
  const uint32_t avmplus_StringBuilder_trimToSize = 62;
  ...
  const uint32_t flash_utils_ByteArray_compress = 91;
  ...
  const uint32_t avmplus_StringBuilder_reverse = 58;
...
extern AvmThunkRetType_AvmBox AVMTHUNK_CALLTYPE shell_toplevel_a2a_oii_opti2_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t flash_trace_Trace_setLevel = 129;
...
extern AvmThunkRetType_void AVMTHUNK_CALLTYPE shell_toplevel_v2a_ou_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t avmplus_StringBuilder_ensureCapacity = 49;
  ...
  const uint32_t flash_utils_ByteArray_position_set = 96;
  ...
  const uint32_t avmplus_StringBuilder_removeCharAt = 56;
  ...
  const uint32_t flash_utils_ByteArray_length_set = 90;
...
extern AvmThunkRetType_void AVMTHUNK_CALLTYPE shell_toplevel_v2a_os_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t flash_utils_ByteArray_writeUTF = 76;
  ...
  const uint32_t flash_utils_ByteArray_endian_set = 98;
  ...
  const uint32_t flash_utils_ByteArray_writeFile = 66;
  ...
  const uint32_t flash_utils_ByteArray_writeUTFBytes = 77;
...
extern AvmThunkRetType_AvmBox AVMTHUNK_CALLTYPE shell_toplevel_a2a_oo_thunkc(AvmMethodEnv env, uint32_t argc, const AvmBox* argv);
  const uint32_t avmplus_JObject_toArray = 144;
  ...
  const uint32_t avmplus_Domain_loadBytes = 37;
  ...
  const uint32_t avmplus_Domain_domainMemory_set = 41;
  ...
  const uint32_t avmplus_Domain_Domain = 36;
  ...
  const uint32_t flash_trace_Trace_setListener = 131;
