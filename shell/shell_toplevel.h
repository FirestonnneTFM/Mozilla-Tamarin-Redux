...
const uint32_t avmplus_System_forceFullCollection = 29;
const uint32_t avmplus_System_queueCollection = 30;
...
const uint32_t avmplus_Domain_currentDomain_get = 47;
const uint32_t avmplus_Domain_MIN_DOMAIN_MEMORY_LENGTH_get = 48;
const uint32_t avmplus_Domain_private_init = 49;
const uint32_t avmplus_Domain_loadBytes = 51;
const uint32_t avmplus_Domain_getClass = 52;
const uint32_t avmplus_Domain_domainMemory_get = 54;
const uint32_t avmplus_Domain_domainMemory_set = 55;
const uint32_t flash_utils_ByteArray_readFile = 58;
const uint32_t flash_utils_ByteArray_writeFile = 59;
const uint32_t flash_utils_ByteArray_readBytes = 60;
const uint32_t flash_utils_ByteArray_writeBytes = 61;
const uint32_t flash_utils_ByteArray_writeBoolean = 62;
const uint32_t flash_utils_ByteArray_writeByte = 63;
const uint32_t flash_utils_ByteArray_writeShort = 64;
const uint32_t flash_utils_ByteArray_writeInt = 65;
const uint32_t flash_utils_ByteArray_writeUnsignedInt = 66;
const uint32_t flash_utils_ByteArray_writeFloat = 67;
const uint32_t flash_utils_ByteArray_writeDouble = 68;
const uint32_t flash_utils_ByteArray_writeUTF = 69;
const uint32_t flash_utils_ByteArray_writeUTFBytes = 70;
const uint32_t flash_utils_ByteArray_readBoolean = 71;
const uint32_t flash_utils_ByteArray_readByte = 72;
const uint32_t flash_utils_ByteArray_readUnsignedByte = 73;
const uint32_t flash_utils_ByteArray_readShort = 74;
const uint32_t flash_utils_ByteArray_readUnsignedShort = 75;
const uint32_t flash_utils_ByteArray_readInt = 76;
const uint32_t flash_utils_ByteArray_readUnsignedInt = 77;
const uint32_t flash_utils_ByteArray_readFloat = 78;
const uint32_t flash_utils_ByteArray_readDouble = 79;
const uint32_t flash_utils_ByteArray_readUTF = 80;
const uint32_t flash_utils_ByteArray_readUTFBytes = 81;
const uint32_t flash_utils_ByteArray_length_get = 82;
const uint32_t flash_utils_ByteArray_length_set = 83;
const uint32_t flash_utils_ByteArray_private_zlib_compress = 84;
const uint32_t flash_utils_ByteArray_private_zlib_uncompress = 86;
const uint32_t flash_utils_ByteArray_private__toString = 88;
const uint32_t flash_utils_ByteArray_bytesAvailable_get = 90;
const uint32_t flash_utils_ByteArray_position_get = 91;
const uint32_t flash_utils_ByteArray_position_set = 92;
const uint32_t flash_utils_ByteArray_endian_get = 93;
const uint32_t flash_utils_ByteArray_endian_set = 94;
const uint32_t native_script_function_flash_sampler_isGetterSetter = 97;
const uint32_t native_script_function_flash_sampler__getInvocationCount = 98;
const uint32_t native_script_function_flash_sampler_getSampleCount = 102;
const uint32_t native_script_function_flash_sampler_getSamples = 103;
const uint32_t native_script_function_flash_sampler_getMemberNames = 104;
const uint32_t native_script_function_flash_sampler_getSize = 105;
const uint32_t native_script_function_flash_sampler__setSamplerCallback = 106;
const uint32_t native_script_function_flash_sampler_sampleInternalAllocs = 109;
const uint32_t native_script_function_flash_sampler_pauseSampling = 110;
const uint32_t native_script_function_flash_sampler_stopSampling = 111;
const uint32_t native_script_function_flash_sampler_startSampling = 112;
const uint32_t native_script_function_flash_sampler_clearSamples = 113;
const uint32_t flash_sampler_NewObjectSample_object_get = 120;
const uint32_t flash_sampler_NewObjectSample_size_get = 121;
const uint32_t flash_trace_Trace_setLevel = 127;
const uint32_t flash_trace_Trace_getLevel = 128;
const uint32_t flash_trace_Trace_setListener = 129;
const uint32_t flash_trace_Trace_getListener = 130;
const uint32_t flash_utils_Dictionary_private_init = 134;
const uint32_t avmplus_JObject_create = 141;
const uint32_t avmplus_JObject_createArray = 142;
const uint32_t avmplus_JObject_toArray = 143;
const uint32_t avmplus_JObject_constructorSignature = 144;
const uint32_t avmplus_JObject_methodSignature = 145;
const uint32_t avmplus_JObject_fieldSignature = 146;
