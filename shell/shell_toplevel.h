...
const uint32_t flash_utils_ByteArray_private__toString = 102;
const uint32_t flash_utils_ByteArray_bytesAvailable_get = 104;
const uint32_t flash_utils_ByteArray_position_get = 105;
const uint32_t flash_utils_ByteArray_position_set = 106;
const uint32_t flash_utils_ByteArray_endian_get = 107;
const uint32_t flash_utils_ByteArray_endian_set = 108;
const uint32_t flash_sampler_isGetterSetter = 111;
const uint32_t flash_sampler__getInvocationCount = 112;
const uint32_t flash_sampler_getSampleCount = 116;
