...
# compile builtins
os.system(asc+" -abcfuture -import ../generated/builtin.abc -builtin "+configs+"-apiversioning -out shell_toplevel shell_toplevel.as Domain.as ../extensions/Sampler.as ../extensions/Trace.as Endian.as Java.as")
